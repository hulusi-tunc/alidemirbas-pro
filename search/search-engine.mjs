// Pure, dependency-free search engine shared by the Next.js API route and
// the filesystem-backed CLI/test wrapper. Keep Node filesystem imports out of
// this module so Turbopack can bundle the API route without tracing the repo.
