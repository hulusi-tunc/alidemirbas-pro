## ACQ-11 — Abandoned Process Recovery (preset: Application Abandonment)

- Canonical ID: `ACQ-11`
- Slug: `abandoned-process-recovery`
- Preset ID: `application-abandonment`
...
- Source route: `/lab/customer-journeys/application-abandonment`
...
**Preset · Application Abandonment**
- canonical rule: The resumable process is a multi-step application with saved state; a hard submission deadline, where one exists, is owned by deadline reminder (TIM-61) through handoff, not by this recovery.
- sets: recovery.first_check = 4 hours–24 hours
...
### Configure
- `recovery.first_check` [recommended default] (recovery-window): 4 hours–24 hours (preset override; canonical default: 30 minutes–60 minutes) — The first check waits long enough after the last activity that the person has actually left the process rather than paused inside it, and no longer than the intent stays fresh.
