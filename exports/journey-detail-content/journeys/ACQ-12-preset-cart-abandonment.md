## ACQ-12 — Abandoned Selection Recovery (preset: Cart Abandonment)

- Canonical ID: `ACQ-12`
- Slug: `abandoned-selection-recovery`
- Preset ID: `cart-abandonment`
...
- Source route: `/lab/customer-journeys/cart-abandonment`
...
**Preset · Cart Abandonment**
- canonical rule: The selection is a shopping cart or basket the person filled without starting checkout; the platform asserts item availability and price.
