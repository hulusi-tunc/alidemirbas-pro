...
- Source route: `/lab/customer-journeys/predicted-need-replenishment`
...
### Configure
- `replenishment.lead_time` [recommended default] (reminder-before-attribute): 3 days–7 days — The prompt is timed a lead period before the expected depletion - long enough for a reorder to arrive before the need bites, short enough that the estimate still means something.
...
### Presets available
- Predicted Next Purchase (`predicted-next-purchase`)
