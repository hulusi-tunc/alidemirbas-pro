## ACQ-11 — Abandoned Process Recovery (preset: Quote Abandonment)

- Canonical ID: `ACQ-11`
- Slug: `abandoned-process-recovery`
- Preset ID: `quote-abandonment`
...
- Source route: `/lab/customer-journeys/quote-abandonment`
...
**Preset · Quote Abandonment**
- canonical rule: The resumable process is a quote or proposal the person configured and did not accept; it has a resume destination and an expiry the quoting system asserts.
