## ACQ-13 — Unresolved Interest Recovery (preset: Browse Abandonment)

- Canonical ID: `ACQ-13`
- Slug: `unresolved-interest-recovery`
- Preset ID: `browse-abandonment`
...
- Source route: `/lab/customer-journeys/browse-abandonment`
...
**Preset · Browse Abandonment**
- canonical rule: The subject is a category or listing the person browsed repeatedly; the touch points back at the category, never at an item the person did not single out.
