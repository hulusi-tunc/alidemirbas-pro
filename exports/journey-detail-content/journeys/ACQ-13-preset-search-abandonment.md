## ACQ-13 — Unresolved Interest Recovery (preset: Search Abandonment)

- Canonical ID: `ACQ-13`
- Slug: `unresolved-interest-recovery`
- Preset ID: `search-abandonment`
...
- Source route: `/lab/customer-journeys/search-abandonment`
...
**Preset · Search Abandonment**
- canonical rule: The subject is a repeated search that led to no selection; the touch points back at the results as they stand. An availability enquiry that holds something is SCH-282's, not this.
- keeps every default of its parent; only the destination and the vocabulary differ
...
### Configure
- `interest.settle_window` [recommended default] (recovery-window): 12 hours–48 hours — The touch waits long enough after the last attention that the person has actually left the subject rather than paused on it, and no longer than the attention stays fresh.
