...
export const metadata: Metadata = {
  ...
  description:
    "283 domain-neutral lifecycle state machines across 26 categories, split into the journeys that reach a person and the ones that resolve inside the system.",
