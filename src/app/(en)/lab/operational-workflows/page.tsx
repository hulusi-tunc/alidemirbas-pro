...
export const metadata: Metadata = {
  ...
  description: intro,
  alternates: pageAlternates("/lab/operational-workflows", "en"),
};

export default function LabOperationalWorkflowsEN() {
  return (
    <LabPage
      lang="en"
      ...
      title={t.title}
      intro={intro}
      extraCrumb={{ name: t.title, url: "/lab/operational-workflows" }}
      browser="gallery"
      surface={KEY}
    />
  );
