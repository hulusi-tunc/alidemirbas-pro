...
const KEY = "operational-workflows" as const;
...
export const metadata: Metadata = {
  ...
  description: intro,
  alternates: pageAlternates("/lab/operational-workflows", "tr"),
};

export default function LabOperationalWorkflowsTR() {
  return (
    <LabPage
      lang="tr"
      ...
      title={t.title}
      intro={intro}
      extraCrumb={{ name: t.title, url: "/tr/lab/operational-workflows" }}
      browser="gallery"
      surface={KEY}
    />
  );
