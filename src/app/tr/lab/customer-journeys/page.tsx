...
const KEY = "customer-journeys" as const;
...
export const metadata: Metadata = {
  ...
  description: intro,
  alternates: pageAlternates("/lab/customer-journeys", "tr"),
};

export default function LabCustomerJourneysTR() {
  return (
    <LabPage
      lang="tr"
      ...
      title={t.title}
      intro={intro}
      extraCrumb={{ name: t.title, url: "/tr/lab/customer-journeys" }}
      browser="gallery"
      surface={KEY}
    />
  );
