  ...
  /* ------------------------------------------------------------ TIM-61 */
  {
    ...
    suppressions: [
      ...
      },
      {
        "id": "s.g5",
        "label": "CANONICAL_RULE",
        "text": "A deadline assigned to an obligation makes this journey the owner of its pre-deadline reminders. The obligation is reminded of once, by whoever governs it."
      }
    ],
    contact: {
