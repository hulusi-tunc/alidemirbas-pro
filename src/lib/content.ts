...
export const copy = {
  en: {
    ...
    stack: {
      ...
      eyebrow: "Tools",
      title: "Tools I use",
      sub: "The tools I use to collect, analyze, test, and turn data into action.",
    ...
    contact: {
      ...
      eyebrow: "Contact",
      title: "Let's talk.",
      sub: "If you'd like to ask a question, share an idea, or talk about one of the projects on this site, feel free to get in touch.",
  ...
  tr: {
    ...
    stack: {
      ...
      sub: "Veriyi toplamak, analiz etmek, test etmek ve aksiyona çevirmek için kullandığım araçlar.",
    ...
    contact: {
      ...
      eyebrow: "İletişim",
      title: "Tanışalım.",
      sub: "Bir soru sormak, fikir paylaşmak ya da buradaki projelerden biri hakkında konuşmak istersen bana yazabilirsin.",
