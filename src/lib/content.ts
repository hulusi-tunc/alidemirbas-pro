  ...
  tr: {
    ...
    lab: {
      ...
      journeysHub: {
        ...
        sub: "Müşteri yaşam döngüsü çalışmaları için sektörden bağımsız bir referans kütüphanesi. Her akış neyin tetiklediğini, kimin girdiğini, nerede dallandığını, kanalların ne yaptığını, ne zaman durduğunu ve başarının nasıl ölçüldüğünü gösterir. Mesaj metni içermez.",
      ...
      journeysSplit: {
        ...
        surfaceBlurbs: {
          "customer-journeys": "Doğrudan müşteriye ulaşan akışlar. Tetikleyici, temas sırası, kanal rolü ve ölçüm çerçevesi birlikte gelir.",
        },
        surfaces: {
          "customer-journeys": {
            title: "Müşteri akışları",
            intro: "{count} müşteri akışı ve {presets} hazır kullanım örneği. Her biri ya kişiye mesaj gönderir ya da işi bir ekibe devreder. Detay sayfası tetikleyiciyi, giriş koşullarını, temas sırasını, kanal rollerini, durma koşullarını ve ölçümü birlikte gösterir.",
          },
        },
