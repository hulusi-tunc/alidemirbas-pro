...
export const copy = {
  ...
  tr: {
      ...
      journeysHub: {
        ...
        split: {
          ...
          lines: {
            ...
            "lifecycle-states": "Kişinin güncel durumunu tutan lifecycle state'leri; journey'ler gönderimden önce bu kayıtları okur.",
            "runtime-mechanisms": "Her gönderimin dayandığı kurallar: uygunluk, ulaşılabilirlik, teslimat ve yeniden deneme.",
          },
          largest: "En büyük journey'ler",
        },
        stories: {
          eyebrow: "İyi bir journey'nin temeli",
    ...
    abTesting: {
      ...
      framework: {
        title: "Her senaryoda üç şey net: neyi değiştiriyorsun, başarıyı neyle ölçeceksin, neyi bozmamalısın.",
        boxes: [
          { title: "Test soruları", desc: "Deneyin yanıtlaması gereken somut sorular ve hipotezler." },
          { title: "Karar metrikleri", desc: "Kazananı belirleyen tek bir birincil KPI ve bozulmaması gereken guardrail metrikleri." },
          { title: "Test riskleri", desc: "Sonucu geçersiz kılabilecek uygulama ve ölçüm hataları." },
        ],
      },
      ...
      product: {
        ...
        story2: {
          ...
          body: "Her senaryo değişen tek alanı adlandırır ve sayfanın geri kalanını aynı tutar. Kütüphanenin büyük bölümünde control ve variant hazır gelir; böylece aynı testte iki değişkenin fark edilmeden değişmesi önlenir.",
        ...
        library: {
          eyebrow: "Kütüphane",
          title: "Test backlog'una eklemek için senaryolara göz at.",
          body: "Senaryoları kategoriye ve sayfaya göre filtreleyebilirsin. Her kayıtta değişen alan, birincil KPI ve guardrail metrikleri birlikte yer alır.",
