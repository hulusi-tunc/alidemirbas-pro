...
const OVERRIDES: Readonly<Record<string, JourneyOverride>> = {
  ...
  nodes: {
    ...
    "w.outcome": { headline: "kişi sunulan elde tutma alternatifini kabul edene, kişi elde tutma alternatifini açıkça reddedene, ilişkinin kendi durumu kişi teklife yanıt vermeden düzelene ya da müdahale uygulanamadığı belli olana kadar", detail: "zaman aşımı: Sınırlı bir karar penceresinin ardından. (yapılandırma: retention_intervention.outcome)" },
    "c.outcome": { headline: "Müdahaleye ne oldu?", edges: [{ label: "Kabul edildi", detail: "müşteri sunulanı kabul etti" }, { label: "Reddedildi", detail: "müşteri bunu açıkça reddetti" }, { label: "Yanıt vermeden düzeldi", detail: "ilişki iyileşti ama teklifin kendisine kimse yanıt vermedi" }, { label: "Uygulanamadı", detail: "müdahale kabul edildi ya da denendi ama gerçekte uygulanmadı" }] },
