...
const OVERRIDES: Readonly<Record<string, JourneyOverride>> = {
  ...
  "ACQ-289": {
  shortName: "Stok Bildirimi",
  name: "Stok bildirimi istendi → ürün yeniden stokta → bildir → satın alma veya çıkış",
  purpose: "Stok bildirimi isteyen kullanıcıya ürün yeniden satışa çıktığında haber vermek ve satın alma gerçekleştiğinde iletişimi durdurmak.",
  nodes: {
  ...
  "ACQ-287": {
  shortName: "Checkout Tamamlama",
  name: "Checkout başladı → tamamlanmadı → hatırlat → satın alma, ödeme hatası veya çıkış",
  purpose: "Checkout'u başlatıp tamamlamayan kullanıcıyı doğru zamanda geri getirmek ve satın alma tamamlandığında iletişimi hemen durdurmak.",
  nodes: {
    "t.started": { headline: "Checkout başladı" },
    "w.first": {
  ...
  "ACQ-288": {
  shortName: "Sepet Hatırlatma",
  name: "Ürün sepete eklendi → checkout başlamadı → hatırlat → checkout, satın alma veya çıkış",
  purpose: "Sepete ürün ekleyip checkout'a geçmeyen kullanıcıyı geri getirmek; yüksek değerli sepetlerde gerekirse daha doğrudan bir kanala geçmek.",
  nodes: {
    ...
    "w.first": {
      ...
      detail: "Zaman aşımı: kişiye sepete kendi başına dönmesi için kısa, sabit bir süre tanı. (ayarla: cart_abandonment.first_check)",
    },
    "c.state1": {
    ...
    "a.reminder1": {
      headline: "İlk sepet hatırlatmasını push ile gönder: sepetindeki ürünlerin hâlâ kişiyi beklediğine dair kısa, öz bir hatırlatma ve sepete dönüş bağlantısı. Sistemin doğrulamadığı hiçbir şey iddia edilmez: rezerve stok, tutulan fiyat, indirim veya son tarih yok.",
    },
    "w.second": {
      headline: "satın alma tamamlanana, sepet boşalana veya süresi dolana kadar",
      detail: "Zaman aşımı: ilk hatırlatmanın kısa, sabit bir süre içinde işe yarayıp yaramadığını gör, ikinci temasın gerekip gerekmediğine ondan sonra karar ver. (ayarla: cart_abandonment.second_check)",
    },
    "c.state2": {
      headline: "Sepet şu anda ne durumda?",
      edges: [
        { label: "Satın alındı", detail: "bu sepetten en az bir ürünü içeren yetkili bir satın alma veya sipariş kaydı mevcut" },
        { label: "Boşaldı veya süresi doldu", detail: "kişi tüm ürünleri kaldırdı, sepeti sildi veya sepetin tutma ya da oturum süresi doldu" },
        { label: "Hâlâ duruyor", detail: "sepet, platformun hâlâ kullanılabilir saydığı en az bir ürünü tutuyor ve hiçbir sipariş kaydedilmedi" },
      ],
    },
    "c.sendable2": {
      headline: "İkinci hatırlatma gönderilebilir mi?",
    ...
    "a.reminder2": {
      headline: "İkinci sepet hatırlatmasını e-posta ile gönder: hâlâ tutulan ürünler, onlar için platformun şu anda belirttiği fayda veya kampanya ve checkout'a giden bağlantı. Sistemin doğrulamadığı hiçbir şey iddia edilmez: rezerve stok, tutulan fiyat, indirim veya son tarih yok.",
    },
    "w.third": {
      headline: "satın alma tamamlanana, sepet boşalana veya süresi dolana kadar",
      detail: "Zaman aşımı: ikinci hatırlatmaya birkaç güne kadar süre tanı, değer eşiğine bağlı son temasın gerekip gerekmediğine ondan sonra karar ver. (ayarla: cart_abandonment.third_check)",
    },
    "c.state3": {
      headline: "Sepet şu anda ne durumda?",
      edges: [
    ...
    "c.highvalue": {
      ...
      edges: [
        ...
        { label: "Standart", detail: "sepetin değeri yapılandırılan eşiğin altındadır - standart değerli bir sepet üçüncü bir temasa ulaşmaz" },
      ],
    },
    "c.sendable3": {
      headline: "Son hatırlatma gönderilebilir mi?",
    ...
    "a.reminder3": {
      headline: "Az önce seçilen kanal üzerinden son sepet hatırlatmasını gönder; yüksek değerli bir sepetin gerektirdiği daha doğrudan üslupla: sepete dön ve alışverişini tamamla. Sistemin doğrulamadığı hiçbir aciliyet yoktur ve bundan sonra başka bir hatırlatma gönderilmez.",
    },
    "w.fourth": {
      headline: "satın alma tamamlanana, sepet boşalana veya süresi dolana kadar",
      detail: "Zaman aşımı: son hatırlatmaya kısa, sabit bir süre tanı; bu sürenin sonunda satın alma tamamlanmadıysa sepet terk edilmiş sayılır. (ayarla: cart_abandonment.final_check)",
    },
    "c.state4": {
      headline: "Kademenin sonunda sepet ne durumda?",
      edges: [
        { label: "Satın alındı", detail: "bu sepetten en az bir ürünü içeren yetkili bir satın alma veya sipariş kaydı mevcut" },
        { label: "Satın alınmadı", detail: "kademenin sonunda bu sepet için hiçbir satın alma kaydı yok - duruyor, boşalmış ya da süresi dolmuş olsun, başka hiçbir şey gönderilmez" },
      ],
    },
    "x.purchased": {
      headline: "Satın Alma Tamamlandı",
    ...
    "x.abandoned": {
      ...
      detail: "hiçbir satın alma kaydedilmedi - kademe sepeti hâlâ tutarken sonuna ulaşmış olsun, sepet yol boyunca geçersiz hale gelmiş (boşalmış veya süresi dolmuş) olsun ya da standart değerli bir sepet değer eşiğine takılıp üçüncü temasa hiç ulaşmamış olsun; kişi için yeni bir sepete-ürün-eklendi olayı kendi saatiyle yeni bir örnek açar, bu örnek yeniden açılmaz",
    },
    "h.checkout": {
      headline: "Ödeme süreci başladı → tamamlanmadı → satın alma veya çıkış",
      detail: "bu sepetten checkout başladı; bu, ilk beklemeden hemen sonra ve ilk hatırlatma gönderilmeden önce bir kez kontrol edilir - o andan itibaren kurtarmayı Checkout Abandonment yürütür",
    },
  },
  },
  "ACC-261": {
  ...
  "ACQ-09": {
  shortName: "Satın Alma Niyetini Güçlendirme",
  name: "Aday müşteri oluştu → niyeti kontrol et → ilgiyi güçlendir → satışa aktar veya akışı bitir",
  purpose: "İlgi göstermiş ancak henüz satın almaya hazır olmayan adayı, niyet sinyallerine göre ilerleyen kısa bir iletişim akışıyla satın almaya yaklaştırmak.",
  nodes: {
    ...
    "c.still-open": { headline: "Aday müşteri hâlâ aynı nurture akışı kapsamında mı?", edges: [{ label: "İlerledi", detail: "ilk temastan bu yana ilerleme sinyali kaydedildi; son temas gönderilmez" }, { label: "İzin geri çekildi", detail: "nurture akışının dayandığı yasal dayanak veya izin artık geçerli değil" }, { label: "Ulaşılabilir kanal yok", detail: "bu kişi için izinli ve ulaşılabilir bir kanal kalmadı" }, { label: "Hâlâ hazır değil", detail: "ilerleme kaydedilmedi, giriş nedeni hâlâ geçerli, izin devam ediyor ve ulaşılabilir bir kanal var" }] },
    ...
    "x.no-basis": { headline: "beklemede, nurture başlatılmadı", detail: "daha sonra verilen izin bunu normal şekilde yeniden açar; yakalamanın kendisi hiçbir zaman onay sayılmadı ve bu süre boyunca hiçbir şey gönderilmedi" },
    ...
    "c.window-olay": { headline: "Beklemeyi ne sonlandırdı?", edges: [{ label: "İlerleme kaydetti", detail: "anlamlı bir ilerleme sinyali geldi" }, { label: "İzin geri çekildi", detail: "bu nurturenin dayandığı yasal dayanak veya izin artık bunu kapsamıyor" }, { label: "Ulaşım yolu kayboldu", detail: "bu kişi için izinli hiçbir hedefe artık ulaşılamıyor" }] },
    ...
    "h.progressed": { headline: "Niyet yükselmesi → satış veya conversion sürecine aktar", detail: "bu kişinin ihtiyacını değiştirecek kadar güçlü bir ilerleme sinyali" },
    "a.stop-permission": { headline: "Bu örnek için kuyrukta bekleyen nurtureyi geçersiz kıl ve nedeni ekle. Yalnızca ilerlemeyle veya kendi süresiyle sona eren bir pencere, dayandığı izin ortadan kalktıktan sonra da göndermeye devam eder" },
    "a.stop-contactability": { headline: "Nurture akışını ilgisizlik olarak işaretlemeden durdur. Kanalın çalışmaması, aday müşterinin ilgisini kaybettiği anlamına gelmez" },
    "x.sunset": { headline: "nurture penceresi ilerleme olmadan kapandı", detail: "yeni bir gelen sinyal veya yeni bir talep yeni bir pencere açabilir; aynı bilgilendirmeye anında yeniden giriş engellenir" },
    "x.permission-ended": { headline: "nurture durduruldu; izin artık bunu kapsamıyor", detail: "yeni ve geçerli bir izin, yeni bir uygun neden ile birleşince yeni bir pencere başlar" },
    "x.unreachable": { headline: "nurture durduruldu; izinli hiçbir yola ulaşılamıyor", detail: "giriş nedeni hâlâ geçerliyken onarılan veya yeni izin verilen bir yol nurtureyi yeniden başlatır" },
  },
  },
  "ACQ-10": {
  ...
  "ACQ-12": {
  shortName: "Kaydedilen Ürün Hatırlatması",
  name: "Ürün kaydedildi → bekle → güncel durumu kontrol et → hatırlat veya akışı bitir",
  purpose: "Kullanıcının kaydettiği ürünü yeniden değerlendirmesini sağlamak; satın alma gerçekleştiğinde veya ürün artık erişilebilir olmadığında iletişimi durdurmak.",
  nodes: {
    ...
    "x.process-started": { headline: "seçimden bir süreç başlatıldı; seçim artık yalnızca tutulan bir şey değil ve bu süreç bunun hakkında söyleyecek başka bir şeye sahip değil", detail: "askıda kalmış ya da terk edilmiş bir süreç, ya da süreç sonuçlandıktan sonra yapılan yeni bir seçim, bu değerlendirmeyi güncel kanıtlardan yeniden açar" },
    "h.oos": { headline: "Ürün alınamazken ilgi kaydedildi → ürün yeniden alınabilir oldu → bildirildi → satın alındı veya kapandı", detail: "ilk temastan önceki stok kontrolünde platform, tutulan tüm ürünlerin artık mevcut olmadığını belirtiyor - aynı kayıtlı ilgi, dönüşünü bildirecek sürece yönlendiriliyor" },
    "c.rearm-budget": {
  ...
  "ACQ-13": {
  shortName: "Ürün İnceleme Sonrası Hatırlatma",
  name: "Ürün ilgisi oluştu → bekle → davranışı kontrol et → hatırlat veya akışı bitir",
  purpose: "Aynı ürünü tekrar inceleyen ancak sepete eklemeyen veya satın almayan kullanıcıya, ilgisi hâlâ güncelse tek bir anlamlı hatırlatma yapmak.",
  nodes: {
    "t.interest": { headline: "İlgi sinyali kaydedildi" },
    "c.qualify": { headline: "Bu ilgi, yeterince güçlü bir ilgi sayılıyor mu ve hâlâ çözümlenmedi mi?", edges: [{ label: "Yeterince güçlü ve çözümlenmedi", detail: "yeterlilik kuralı sağlanıyor, bir seçim, sipariş veya süreç izlenmedi, konu mevcut, izin kayıtlı ve açık bir örnek yok" }, { label: "Zaten sonuçlandı", detail: "ilgiden bu yana konu için bir seçim, sipariş veya süreç mevcut" }, { label: "Yeterince güçlü değil", detail: "kural sağlanmıyor, konu mevcut değil ya da zaten tutuluyor, ya da izin yok - neden kaydedilir" }] },
    ...
    "x.resolved": { headline: "sonuçlandı; konu için bir seçim, süreç veya satın alma kaydedildi - bu, kendi sürecinin gerçek tetikleyicisidir (sepete geri dönerek yapılan bir seçim, ACQ-288'in kendi giriş olayıdır), bu sürecin doğrudan yönlendirdiği bir şey değil", detail: "yeni bir ilgi anahtarı yeni bir ilgidir" },
  ...
  nodes: {
    ...
    "x.blocked": { headline: "zorunlu bir ön koşul eksik; adı konmuş gereksinim var olana kadar onboarding başlayamaz", detail: "gereksinimin çözülmesi, yönlendirmeyi güncel onboarding bağlamından yeniden açar" },
    "x.ready": { headline: "rota seçildi, başlangıcı engelleyen bir şey yok; hesap kendi başına kuruluma başlamaya hazır", detail: "sonradan keşfedilen zorunlu bir ön koşul bu değerlendirmeyi güncel kanıtlardan yeniden açar" },
  },
  },
  "ACT-14": {
  shortName: "Onboarding Yardımı",
  name: "Kullanıcı takıldı → yardım sun → gerekirse kanalı güçlendir → devam veya çıkış",
  purpose: "Onboarding sırasında ilerlemekte zorlanan kullanıcıya, süreç terk edilmeden önce ihtiyacına uygun destek sunmak.",
  nodes: {
    ...
    "c.classify": { headline: "Zorlanma davranışı olası sebep olarak neyi gösteriyor?", edges: [{ label: "Form veya bilgi girişi sorunu", detail: "aynı alanda zorunlu alan hataları veya bir doğrulama problemi tekrarlanıyor" }, { label: "Teknik hata", detail: "bir hata mesajı tekrarlanıyor, ya da davranış kişinin kendi girdisinden çok sistemsel bir soruna işaret ediyor" }, { label: "Nasıl yapılacağını bilmiyor", detail: "adımdaki bekleme süresi uzun, ya da kişi bir kılavuz sayfası aramaya gitti" }, { label: "Sorun belirsiz", detail: "zorlanma sinyalleri genel ve hiçbiri sebebi daha fazla daraltmıyor" }] },
    "a.offer-inapp": { headline: "Bu adımda yardıma ihtiyaçları olup olmadığını soran bir uygulama içi mesaj göster; sınıflandırılan sebebe uyan kısa açıklamayı, adım adım kılavuzu ya da sık yapılan hatalar notunu öne çıkar; canlı desteği başlatma ve daha sonra devam etmeyi tercih etme seçeneğiyle birlikte" },
    "w.tier1": { headline: "ürünün kendi kaydı takıldıkları adımı tamamlanmış olarak işaretleyene, bir destek talebi kaydedilene ya da kişi yardım teklifini açıkça reddedene kadar", detail: "zaman aşımı: Uygulama içi teklifin ardından kısa, sabit bir süre - akış adımı yeniden okuyup push aşamasına geçmeden önce. (struggling_user.tier1_window üzerinden yapılandırılır)" },
    "c.tier1-response": { headline: "Uygulama içi mesaja karşılık ne yaptılar?", edges: [{ label: "Adımı tamamladı", detail: "ürünün kendi kaydı takıldıkları adımı tamamlanmış olarak işaretliyor" }, { label: "Canlı desteği başlattı", detail: "uygulama içi mesajdaki canlı destek seçeneğini seçtiler" }, { label: "Daha sonra devam etmeyi seçti", detail: "şimdi hareket etmek yerine uygulama içi mesajın daha-sonra-devam-et seçeneğini açıkça seçtiler" }] },
    "c.tier1-check": { headline: "Takıldıkları adım tamamlandı mı?", edges: [{ label: "Evet", detail: "ürünün kendi kaydı takıldıkları adımı tamamlanmış olarak işaretliyor" }, { label: "Hayır", detail: "adım hâlâ tamamlanmış olarak kaydedilmedi" }] },
    "a.push-reminder": { headline: "Kaldıkları yerden devam edebileceklerini söyleyen bir push bildirimi gönder; tamamlanmamış adımı adlandır, kısa bir motive edici cümle ve o adıma dönen bir derin bağlantı ekle" },
    "w.tier2": { headline: "ürünün kendi kaydı takıldıkları adımı tamamlanmış olarak işaretleyene kadar", detail: "zaman aşımı: Push hatırlatmasının ardından kısa, sabit bir süre - akış adımı yeniden okuyup e-posta ve canlı destek aşamasına geçmeden önce. (struggling_user.tier2_window üzerinden yapılandırılır)" },
    "c.tier2-check": { headline: "Uygulamaya geri döndüler ve adımı tamamladılar mı?", edges: [{ label: "Evet", detail: "ürünün kendi kaydı takıldıkları adımı tamamlanmış olarak işaretliyor" }, { label: "Hayır", detail: "adım hâlâ tamamlanmış olarak kaydedilmedi" }] },
    "a.email-remind": { headline: "Tamamlanmamış adımı özetleyen bir mesaj gönder; adım adım bir kılavuz veya kısa bir video, SSS bağlantıları ve bir canlı destek bağlantısıyla birlikte" },
    "a.live-support-offer": { headline: "Aynı mesajın yanında, destek ekibinin doğrudan yardımcı olmasını teklif et: canlı sohbet başlat, bir destek talebi aç, uygun bir zaman aralığı seç ya da bir iletişim tercihi belirt" },
    "w.tier3": { headline: "bu onboarding için yetkili aktivasyon olayı kaydedilene ya da bir destek talebi kaydedilene kadar", detail: "zaman aşımı: Mesaj ve canlı destek teklifinin ardından kısa, sabit bir süre - akış tam onboarding tamamlanmasını yeniden okuyup örneği her iki yönde de kapatmadan önce. (struggling_user.tier3_window üzerinden yapılandırılır)" },
    "c.tier3-response": { headline: "Mesaja ve canlı destek teklifine karşılık ne yaptılar?", edges: [{ label: "Onboarding tamamlandı", detail: "bu onboarding için yetkili aktivasyon olayı kaydedildi" }, { label: "Canlı desteği başlattı", detail: "bir sohbet başlattılar, bir destek talebi açtılar ya da canlı destek teklifini başka bir şekilde kullandılar" }] },
  ...
  "ACT-17": {
  shortName: "Kullanım Alışkanlığı Geliştirme",
  name: "İlk değer oluştu → tekrar kullanımı destekle → düzenli kullanım veya yeniden etkileşim",
  purpose: "İlk değer anını yaşayan kullanıcıyı, ürünün gerçek kullanım ritmine uygun şekilde tekrarlanan ve düzenli kullanıma taşımak.",
  nodes: {
    "t.activated": { headline: "Temel aktivasyon tamamlandı" },
    "c.next": { headline: "Az önce yaptıklarından doğal bir sonraki eylem çıkıyor mu?", edges: [{ label: "Evet", detail: "ürettikleri şeyden somut bir şey doğuyor - onu paylaşmak, tekrarlamak, genişletmek" }, { label: "Hayır", detail: "gerçekten hiçbir şey doğmuyor ve uydurma bir sonraki adım, mesajı bir satış mesajına dönüştürür" }] },
  ...
  "ACT-20": {
  shortName: "Pasif Lead'i Yeniden Aktifleştirme",
  name: "Lead pasifleşti → son davranışı kontrol et → geri dönüş nedeni sun → yeniden nitelendir veya çık",
  purpose: "Henüz müşteriye dönüşmemiş pasif bir lead'i, son anlamlı davranışına ve gerçek bir geri dönüş nedenine göre yeniden harekete geçirmek.",
  nodes: {
    "t.dormant": { headline: "Etkileşimli, müşteri olmayan kişi pasifleşti" },
    "c.never-monetized": { headline: "Bu ilişki bu bağlamda hiç ücretli müşteriye dönüştü mı?", edges: [{ label: "Hiç ödeme yapmadı", detail: "bu bağlamda bir müşteri veya ücretli ilişki hiç var olmadı" }, { label: "Ödeme yapan müşteriydi", detail: "ücretli müşteri ilişkisi var ya da bir zamanlar vardı" }] },
    ...
    "x.no-reason": { headline: "pasif, yeniden etkileşime geçmek için inandırıcı bir neden yok", detail: "gerçek bir değişiklik - üründe, kendi koşullarında, talep ettikleri şeyde - ileride bir neden yaratabilir; sadece pasif kalmanın uzaması tek başına asla neden hâline gelmez" },
    "w.return": { headline: "üründe gerçek bir etkinlik ya da funnel'dan bir hareket olana kadar - bir mesajın açılması değil", detail: "zaman aşımı: Yeniden aktifleştirme penceresi. (dormant_non.return üzerinden yapılandırılır)" },
    ...
    "x.sunset": { headline: "yeniden aktifleştirme penceresi kapandı, bekleme süresi devrede", detail: "yalnızca yeni bir neden bunu değiştirir, daha uzun bir sessizlik değil; tekrarlanan pasif kalma, kimseye tekrarlanan kampanya hakkı vermez" },
    ...
    "x.resumed": { headline: "tamamlanmamış kuruluma geri dönüldü; tamamlanmış tamamlanan adımlar korunur ve hesap baştan başlamak yerine kaldığı yerden devam eder", detail: "sonraki bir geri dönüş aynı kilometre taşı kaydını yeniden okur" },
    "h.intent": { headline: "Niyet yükseldi → daha yüksek niyetli sürece devir", detail: "kayıttakinden daha güçlü niyet taşıyan bir geri dönüş" },
  ...
  nodes: {
    ...
    "x.resign-needed": { headline: "yetkili olmayan bir sürüme bağlı bir imza, yalnızca o sürüm için kanıt olarak kaydedilir; yetkili sürümün hâlâ bağlayıcı bir imzası yok, ama bu boşluğu devredecek bir imza motoru bu süreçte bulunmuyor", detail: "bu soy kütüğündeki daha sonraki bir tutarsızlık, bu kaydı kanıtının bir parçası olarak değerlendirir" },
  ...
  nodes: {
    ...
    "a.classify": { headline: "Operasyonel anlamı kendi alanında POSITIVE, PRODUCT_SUGGESTION, COMPLAINT, BUG_REPORT, INFO_REQUEST, OTHER veya UNKNOWN olarak sınıflandır. Bir sınıflandırma bir yönlendirme kararıdır, neyin yanlış gittiğine dair bir bulgu değildir" },
    "c.classify": { headline: "Bu geri bildirim ne tür bir geri bildirim?", edges: [{ label: "Olumlu memnuniyet", detail: "teşekkür, övgü ya da deneyime dair olumlu bir anlatım" }, { label: "Ürün geliştirme önerisi", detail: "yeni bir özellik ya da bir iyileştirme önerisi" }, { label: "Şikayet veya düşük memnuniyet", detail: "olumsuz bir deneyim ya da bir hizmet sorunu" }, { label: "Hata bildirimi", detail: "uygulama veya teknik bir sorun, bir arıza olarak bildirilmiş" }, { label: "Bilgi talebi", detail: "ürün, hizmet, poliçe veya benzeri bir konuda soru" }, { label: "Diğer", detail: "bizimle ilgisi yok, ya da aksiyon gerektirmiyor" }, { label: "Anlamı belirsiz", detail: "anlam, yukarıdakilerden birine sınıflandırılabilecek kadar güvenilir şekilde belirlenemiyor" }] },
    "a.thank": { headline: "Olumlu geri bildirim için bir teşekkür mesajı gönder" },
    "a.route-product": { headline: "Öneriyi ürün/insight havuzuna aktar ve alındığına dair bir bilgilendirme gönder" },
    "a.route-support": { headline: "Şikayet için destek sürecini başlat ve inceleniyor olduğuna dair bir bilgilendirme gönder" },
    "a.route-technical": { headline: "Hata bildirimi için teknik süreci başlat ve inceleniyor olduğuna dair bir bilgilendirme gönder" },
    "a.provide-info": { headline: "İstenen bilgiyi sağla, ya da bunu sağlayabilecek içeriğe veya ekibe yönlendir" },
    "a.thank-close": { headline: "Geri bildirim için teşekkür et; bununla ilgili herhangi bir aksiyon gerekmiyor" },
    ...
    "w.sla": { headline: "SLA süresi bekle", detail: "Zaman aşımı: kişiye söylenen süre kadar bekle, ardından söz verilen aksiyonun gerçekleşip gerçekleşmediği yeniden okunur - kişiye ne söz verildiyse ona uyan sabit bir süre, bu sürecin kendi başına uydurduğu bir son tarih değil. (örnek: 1 gün–3 gün; yapılandırma: feedback.sla_wait)" },
    "c.completed": { headline: "Söz verilen aksiyon tamamlandı mı?", edges: [{ label: "Tamamlandı", detail: "kayıt, söz verilen aksiyonun tamamlandığını gösteriyor" }, { label: "Tamamlanmadı", detail: "söz verilen süre geçmesine rağmen aksiyon hâlâ beklemede" }] },
    "a.closure-notice": { headline: "Kullanıcıya, söz verilen aksiyonla ilgili ne olduğunu bildiren bir kapanış bildirimi gönder ve kaydı kapat" },
    "a.reminder": { headline: "Söz verilen aksiyondan sorumlu ekibe, bunun henüz gerçekleşmediğine dair bir hatırlatma gönder" },
    "w.followup": { headline: "söz verilen geri dönüş yapılana kadar", detail: "Zaman aşımı: Söz verilen bir geri dönüş, yalnızca bu sözün kişi için hâlâ bir anlam taşıdığı süre boyunca beklenir; bu sürenin ötesinde bu, tutulmamış bir söz haline gelir ve öyle olarak yükseltilir. Söz, kendi tarihini taşır. (yapılandırma: feedback.promise_window)" },
  ...
  nodes: {
    ...
    "a.delay-update": { headline: "Güncel tahmini ve işaret ettiği tarihi, arkasında korunan orijinal taahhütle birlikte belirt. Kayıtta gerçek olup bekleyen kişi için görünmez kalan bir gecikme, bu sürecin önlemek için var olduğu başarısızlıktır - ve bu, tolerans içindeyken de geçerlidir, çünkü tolerans bize aittir, onlara değil" },
    "a.status-update": { headline: "Güvenilir bir tahminin henüz bulunmadığını açıkça belirt ve neden bir tarih belirleyecek kadar iyi anlaşıldığında kesin bir tarihin paylaşılacağını söyle. Tutulmayacak tarihleri tekrar tekrar vadetmek, tarihin bilinmediğini kabul etmekten daha fazla güven kaybettirir; her bozulan tarih bir sonrakini daha değersiz kılar" },
    "w.check1": { headline: "ifa devam edene veya tamamlanana kadar", detail: "zaman aşımı süresi: Gecikme bildiriminden sonraki kısa, sabit bir süre, kayıt teslimat için yeniden okunmadan önce. (fulfillment_delay.first_recheck içinden yapılandırın)" },
    "c.delivered": { headline: "Kayıt, yükümlülüğün yerine getirildiğini gösterdi mi?", edges: [{ label: "Teslim edildi", detail: "sistem kaydı artık yükümlülüğün yerine getirildiğini gösteriyor" }, { label: "Teslim edilmedi", detail: "yükümlülük güncel tahminine karşı hâlâ açık" }] },
    ...
    "h.exception": { headline: "İfa istisnası → teşhis → kurtarma, ikame veya başarısızlık", detail: "karşı tarafın beklemek yerine farklı bir teslimat noktası seçmesi" },
    ...
    "h.escalate": { headline: "Sorumluluk yükseltme → üst merci → çözüm veya iade", detail: "sunacak bir şey olmadan tolerans dışına çıkan, revize edilmiş ufkunu aşan ya da karşı tarafın otomatik seçenekler arasından seçim yapmak yerine açıkça bir kişiden yardım istemesi" },
  },
  },
  "FUL-147": {
  ...
  nodes: {
    ...
    "x.rejected": { headline: "Bu iddia için REJECTED (REDDEDİLDİ); kanıt onu kanıtlamıyor", detail: "farklı bir iddia kendi kanıtıyla doğrulanır; bu iddia ise kendi retry politikası kapsamında yeni kanıtla yeniden denenebilir" },
  ...
  nodes: {
    ...
    "x.no-return-route": { headline: "iade edilemeyecek bir şey için iade talep edildi; talep ve arkasındaki çözülmemiş yükümlülük ile hiçbir iade yolunun bulunmadığı gerçeği kaydedildi, ancak yerine hangi çözümün geleceğine bu süreçte bir çözüm motoru karar vermiyor", detail: "yükümlülüğün başka bir şekilde çözülmesi bu talebin kaydına işlenir" },
  ...
  nodes: {
    ...
    "x.correction-failed": { headline: "bir düzeltme denendi ve gereken sonucu üretemedi; denenen şey, başarısızlık nedeni ve çözülmemiş yükümlülük kaydedildi, ancak hangi çözümün kaldığına bu süreçte bir çözüm motoru karar vermiyor", detail: "yeni bir çözüm denemesinin kaydedilmesi bu düzeltmenin geçmişine işlenir" },
  },
  },
  "RET-21": {
  ...
  nodes: {
    ...
    "h.technical": { headline: "external:human-in-the-loop-yaşam döngüsü", detail: "çözülmemiş bir teknik sorun, eksik ya da bozuk bir kurulum bağımlılığı, ya da tekrarlayan destek sürtünmesi" },
  ...
  "RET-24": {
  shortName: "Churn Riski Yönetimi",
  name: "Churn riski yükseldi → risk seviyesini belirle → uygun müdahaleyi uygula → toparla veya izle",
  purpose: "Yükselen churn riskine tek bir genel retention kampanyasıyla değil, risk seviyesine ve olası nedene göre kademeli aksiyonlarla yanıt vermek.",
  nodes: {
    "t.threshold": { headline: "Churn riski eşiği aşıldı" },
    "a.evaluate": { headline: "Eşiği aşan sinyalleri değerlendir: kaç bağımsız sinyal olduğu, her birinin gücü, müşterinin segmenti ve değeri, sözleşme ya da yenileme tarihi ve ilişkinin bugüne kadarki davranışı" },
    "c.risk-level": { headline: "Değerlendirilen sinyaller hangi risk seviyesine denk geliyor?", edges: [{ label: "Düşük risk", detail: "tek bir zayıf sinyal var ve başka hiçbir şey bunu desteklemiyor" }, { label: "Orta risk", detail: "iki sinyal var, ya da kullanım durmayan sürekli bir düşüş içinde" }, { label: "Yüksek risk", detail: "üç ya da daha fazla güçlü sinyal var, ya da sinyallerden biri tek başına kritik" }] },
    "a.push-value": { headline: "Hesabın en değerli özelliğini vurgulayan, kısa ve fayda odaklı bir push bildirimi gönder - tanı sorusu yok, teklif yok" },
    "w.low-wait": { headline: "3 gün bekle", detail: "zaman aşımı: En hafif katmanın işe yarayıp yaramadığına, yükseltmeden önce karar vermek için tanınan kısa, sabit süre. (yapılandırma: churn_risk.low_tier_window)" },
    "c.low-outcome": { headline: "Kullanım geri geldi mi?", edges: [{ label: "Düzeldi", detail: "bir giriş yeniden yapıldı, kritik özellik yeniden kullanılıyor ve risk puanı düştü" }, { label: "Henüz değil", detail: "bunların hiçbiri doğru değil" }] },
    "a.email-features": { headline: "Bu hesabın kaçırıyor olabileceği özellikleri, daha fazla değer elde etmenin yollarıyla birlikte anlatan bir e-posta gönder - aşağıdaki uygulama içi mesajla birlikte" },
    "a.inapp-relevant": { headline: "İlgili özelliği vurgulayan, kısa rehberlik içeren bir uygulama içi mesaj göster, bu pencerede ürünü açan herkese - yukarıdaki e-postayla birlikte, ayrı bir sonraki temas olarak değil" },
    "w.medium-wait": { headline: "3–5 gün bekle", detail: "zaman aşımı: Orta katmanın daha kapsamlı içerik ve rehberliğinin işe yarayıp yaramadığına, yükseltmeden önce karar vermek için tanınan daha uzun, sabit süre. (yapılandırma: churn_risk.medium_tier_window)" },
    "c.medium-outcome": { headline: "Kullanım toparlandı mı?", edges: [{ label: "Düzeldi", detail: "giriş sıklığı arttı, özellik kullanımı arttı ve risk puanı düştü" }, { label: "Henüz değil", detail: "bunların hiçbiri doğru değil" }] },
    "a.whatsapp-experience": { headline: "WhatsApp üzerinden deneyimin daha iyi hale getirilip getirilemeyeceğini doğrudan sor, kısa bir anket ya da açık uçlu bir soruyla, ve yanıt isterse destek ya da bir danışmana giden bir yol sun" },
    "w.high-wait": { headline: "2–3 gün bekle", detail: "zaman aşımı: Müdahalenin en kısa sabit süresi - çünkü yüksek riskli bir ilişki bekletilecek bir ilişki değildir. (yapılandırma: churn_risk.high_tier_window)" },
    "c.high-outcome": { headline: "Sorun çözüldü mü?", edges: [{ label: "Düzeldi", detail: "kullanım geri geldi, varsa ödeme sorunu çözüldü, varsa destek talebi kapatıldı ve risk puanı düştü" }, { label: "Henüz değil", detail: "bunların hiçbiri doğru değil" }] },
    "c.issue-type": { headline: "WhatsApp teması sorunu çözmediyse, riskin arkasındaki sorun ne türde?", edges: [{ label: "Fiyat ya da değer problemi", detail: "hesap, ödediği ücrete ya da algılanan değere karşı ilgisini kaybediyor" }, { label: "Ürün kullanım problemi", detail: "hesap, üründen değer elde etmeyi henüz öğrenmedi" }, { label: "Teknik problem", detail: "belirli bir şey bozuk ya da çözülmemiş ve bu, bu ilişkide açık bir ödeme kurtarma örneği olan bir ödeme hatası değil - o nedenin zaten bir sahibi var" }, { label: "Ödeme problemi", detail: "risk, bir ödeme hatasına, başarısız bir yönteme ya da hesabın artık ödeme şekline uymayan bir plana dayanıyor" }, { label: "Memnuniyetsizlik ya da şikayet", detail: "kanıt, bir kişiye ihtiyaç duyan açık memnuniyetsizlik ya da çözülmemiş bir şikayet - başka bir otomatik temas değil" }, { label: "Belirgin bir sorun yok, kullanım hâlâ düşüyor", detail: "hiçbir şey nedeni özel olarak tanımlamıyor ve düşüş başka türlü açıklanamıyor" }] },
    "a.issue-price": { headline: "Özel bir indirim ya da daha uygun bir plan sun, ve plan değişikliğini doğrudan öner" },
    "a.issue-usage": { headline: "Bir nasıl yapılır rehberine, canlı bir demoya ya da webinara ve birebir katılım desteğine yönlendir" },
    "a.issue-technical": { headline: "Hesabı destek ekibine yönlendir, sorunu çözülene kadar takip et ve kapandığında bir memnuniyet sorusu sor" },
    "h.resolve-first": { detail: "WhatsApp temasının çözemediği, tanımlanabilir bir operasyonel nedeni olan risk" },
    "a.issue-payment": { headline: "Ödeme hatasını çöz, alternatif bir ödeme yöntemi sun ve esnek ödeme seçeneklerini anlat" },
    "a.issue-complaint": { headline: "Hesabı bir kişinin önüne koy - insan destek ya da hesap temsilcisi - sorunu çözülene kadar sahiplen ve kapandığında NPS'i öl" },
    "h.human": { detail: "bir kişiye ihtiyaç duyan, çözülmemiş bir şikayet ya da memnuniyetsizlik" },
    "a.issue-noclear": { headline: "Kişiselleştirilmiş değer önerileri gönder, henüz denenmemiş özellikleri tanıt ve kısa bir içerik ya da rehber serisiyle devam et" },
    "a.final-email": { headline: "Son bir kez, kişiselleştirilmiş bir indirimi ya da planı süreli bir teklif olarak gönder - aşağıdaki WhatsApp hatırlatmasıyla birlikte" },
    "a.final-whatsapp": { headline: "Teklifi hızlı bir eylem bağlantısıyla özetleyen kısa bir WhatsApp hatırlatması gönder, yukarıdaki e-postayla birlikte" },
    "w.final-wait": { headline: "3–5 gün bekle", detail: "zaman aşımı: Hesap pasif takibe alınmadan önce son elde tutma teklifine tanınan son sabit süre. (yapılandırma: churn_risk.final_tier_window)" },
    "c.final-outcome": { headline: "Kullanım ya da satın alma toparlandı mı?", edges: [{ label: "Düzeldi", detail: "kullanım ya da bir satın alma ölçülebilir şekilde toparlandı" }, { label: "Henüz değil", detail: "müdahalenin tamamı boyunca hiçbir şey ölçülebilir şekilde toparlanmadı" }] },
    "x.recovered": { headline: "ilişki düzeldi; risk daha fazla yükseltme olmadan ortadan kalktı", detail: "eşik yeniden aşılırsa, yeni bir risk değerlendirmesi yeni bir örnektir" },
    "x.passive-monitoring": { headline: "tüm müdahale adımları boyunca toparlanma olmadı; churn riski pasif takibe alındı", detail: "bu hesapta eşiğin yeniden aşılması, güncel kanıtlardan yeni bir bölüm açar" },
  },
  },
  "RET-27": {
  ...
  name: "Tükenme öngörüldü → kademeli hatırlatma zinciri → yenilendi, abone olundu ya da sona erdi",
  purpose: "Tüketilebilir ya da tekrarlı kullanımlı bir ürünün kullanılabilir süresinin sona ereceği öngörülmeden kısa bir süre önce kişiye yenileme hatırlatması yapın, öngörüyü bir tahmin olarak belirtin, düzenli tekrar alıcıları önce bir aboneliğe yönlendirin ve kişi satın aldığı, abone olduğu ya da zincir tükendiği anda durdurun.",
  nodes: {
    "t.predicted": { headline: "Beklenen tükenme yaklaşıyor" },
    "c.reliable": { headline: "Tahmin güvenilir mi?", edges: [{ label: "Güvenilir", detail: "tahminin arkasındaki satın alma ve kullanılabilir süre verisi, buna güvenilir muamele etmeyi destekliyor" }, { label: "Güvenilir değil", detail: "tahminin arkasındaki veri, buna göre hareket etmeyi desteklemiyor" }] },
    "x.not-started": { headline: "yolculuk hiç açılmadı; tahmin harekete geçmeye yetecek kadar güvenilir değildi", detail: "satın alma geçmişi büyüdükçe hesaplanan bir sonraki öngörü döngüsü, tahmin o zaman güvenilirse yeni bir örnek açabilir" },
    "c.already-bought": { headline: "Kullanıcı ürünü zaten yeniden satın aldı mı?", edges: [{ label: "Zaten satın aldı", detail: "tahminin dayandığı satın almadan bu yana ihtiyacın bir satın alması kaydedildi" }, { label: "Henüz almadı", detail: "ihtiyacın daha yeni bir satın alması kaydedilmedi" }] },
    "x.already-repurchased": { headline: "zaten yeniden satın aldı; hiçbir temas gitmeden önce ihtiyacın bir satın alması kaydedildi", detail: "bu satın almadan hesaplanan bir sonraki öngörü döngüsü, bir sonraki örneği açar" },
    "c.product-ref": { headline: "Aynı ürün hâlâ satışta ve stokta mı?", edges: [{ label: "Aynı ürün", detail: "tahminin hesaplandığı ürün hâlâ satışta ve stokta" }, { label: "Uyumlu alternatif", detail: "asıl ürün artık satışta ya da stokta değil, ve uyumlu bir alternatif ya da yeni bir versiyon var" }] },
    "a.touch1": { headline: "Ürünü belirtin - önceki koşulun seçtiği asıl ürünü, ya da o artık mevcut değilse uyumlu alternatifi ya da yeni versiyonu - ne zaman tükeneceğinin tahmin edildiğini ve bunun kendi satın almalarından yapılan bir tahmin olduğunu söyleyin ve yeniden sipariş yolunu verin. Ellerinde ne kaldığına dair hiçbir iddiada bulunmayın; ayrılmış stok, tutulan fiyat ya da indirim yok" },
    "w.touch1": { headline: "2 gün bekle", detail: "zaman aşımı: Açılış bildiriminin işe yarayıp yaramadığına, zincirin satın alma kaydını yeniden okuyup kademeli hatırlatmaya geçmeden önce karar vermek için tanınan kısa, sabit süre. (yapılandırma: replenishment.first_window)" },
    "c.outcome1": { headline: "Satın aldı mı?", edges: [{ label: "Satın aldı", detail: "ihtiyacın bir satın alması kaydedildi" }, { label: "Henüz almadı", detail: "ihtiyacın bir satın alması kaydedilmedi" }] },
    "c.regular": { headline: "Kullanıcı bu ürünü düzenli tekrar alıyor mu - geçmişinde bir tekrar alma düzeni var mı?", edges: [{ label: "Düzenli tekrar alıcı", detail: "kişinin kendi satın alma geçmişi bu ihtiyaç için sabit bir düzen gösteriyor" }, { label: "Düzen yok", detail: "kişinin satın alma geçmişi bu ihtiyaç için sabit bir düzen göstermiyor" }] },
    "a.subscribe-email": { headline: "Kişiye bu ürünü düzenli aldığını söyleyen ve bir abonelik ya da otomatik yenileme seçeneği sunan bir e-posta gönderin - aşağıdaki eşlik eden temasla birlikte" },
    "a.subscribe-inapp": { headline: "Aynı abonelik ya da otomatik yenileme seçeneğini sunan bir uygulama içi mesaj gösterin, bu pencerede ürünü açan herkese - yukarıdaki eşlik eden temayla birlikte, ayrı bir sonraki temas olarak değil" },
    "c.subscribed": { headline: "Aboneliğe geçti mi?", edges: [{ label: "Abone oldu", detail: "kişi ihtiyacı kapsayan bir abonelik ya da otomatik yenileme yetkilendirdi" }, { label: "Reddetti", detail: "hiçbir abonelik ya da otomatik yenileme yetkilendirilmedi" }] },
    "x.subscribed": { headline: "aboneliğe ya da otomatik yenilemeye geçti; ihtiyacı artık kapsıyor", detail: "ihtiyaç artık abonelikle kapsanıyor; yeni bir örnek yalnızca abonelik daha sonra sona ererse yeniden açılır" },
    "a.touch2b": { headline: "Son satın alma tarihini ve tahmini tükenme zamanını hatırlatan bir e-posta gönderin, ve yeniden siparişi, ekonomik bir paketi ya da çoklu bir paketi önerin - düzeni olmayan biri için doğrudan, ya da düzenli bir tekrar alıcı abonelik teklifini reddettiğinde ulaşılır" },
    "w.touch2b": { headline: "3 gün bekle", detail: "zaman aşımı: Hatırlatma e-postasının işe yarayıp yaramadığına, zincirin satın alma kaydını yeniden okuyup kapanış WhatsApp temasına geçmeden önce karar vermek için tanınan kısa, sabit süre. (yapılandırma: replenishment.reminder_window)" },
    "c.outcome2": { headline: "Satın aldı mı?", edges: [{ label: "Satın aldı", detail: "ihtiyacın bir satın alması kaydedildi" }, { label: "Henüz almadı", detail: "ihtiyacın bir satın alması kaydedilmedi" }] },
    "a.touch3": { headline: "WhatsApp üzerinden ürünün yakında bitebileceğini söyleyin, kısa ve doğrudan, net bir yeniden satın alma bağlantısıyla ve uydurulmuş bir aciliyet olmadan" },
    "c.outcome3": { headline: "Satın aldı mı?", edges: [{ label: "Satın aldı", detail: "ihtiyacın bir satın alması kaydedildi" }, { label: "Satın almadı", detail: "ihtiyacın bir satın alması kaydedilmedi" }] },
    "x.repurchased": { headline: "yenilendi; ihtiyacın bir satın alması kaydedildi", detail: "bu satın almadan hesaplanan bir sonraki öngörü döngüsü, bir sonraki örneği açar" },
    "x.ended": { headline: "zincir tükendi; ne yenilendi ne de abone olundu, bu döngüde başka bir şey yok", detail: "bir sonraki öngörü döngüsü yeni bir örnek açar" },
  },
  },
  "RET-32": {
  ...
  nodes: {
    ...
    "x.remainder-owed": { headline: "randevu gerçekleşti ama hizmet yalnızca kısmen teslim edildi; teslim edilen kapsam ve kalan yükümlülük ayrı ayrı kaydedildi, ancak bunu çözecek bir çözüm motoru bu süreçte yok", detail: "kalan yükümlülüğün çözülmesi bu tekrarın kaydına işlenir" },
  ...
  nodes: {
    ...
    "x.service-obligation-owed": { headline: "sağlayıcı kaynaklı bir arızayla bir hizmet yükümlülüğü çözülmeden kaldı; yükümlülüğün kendisi ve müşterinin hiçbir hata yapmadığı kaydedildi, ancak bunu çözecek bir çözüm motoru bu süreçte yok", detail: "yükümlülüğün çözülmesi bu arızanın kaydına işlenir" },
  ...
  "SCH-266": {
  shortName: "Randevu Hazırlığı Hatırlatması",
  name: "Randevu tarihi yaklaşıyor → ön koşullar ve son hatırlatma → hazır veya süresi doldu",
  purpose: "Müşterinin, onaylanmış bir taahhüde düşen kısmını randevu gelmeden önce tamamlatmak, ve son hatırlatmayı rezervasyonun yapıldığı andaki durumundan değil, o anki durumundan göndermek.",
  nodes: {
    "t.booking": { headline: "Müşteriye ait ön koşulları olan onaylanmış rezervasyon" },
    "c.prereq1": { headline: "Ön koşullar tamam mı?", edges: [{ label: "Hayır", detail: "müşterinin borçlu olduğu en az bir ön koşul hâlâ eksik" }, { label: "Evet", detail: "müşterinin borçlu olduğu her ön koşul karşılanmış olarak kaydedildi" }] },
    "a.email-missing": { headline: "Eksik ön koşulu, kime ait olduğunu ve nasıl tamamlanacağını belirt. Yapacak üç şeyi olan biri tek bir sorunla karşı karşıyadır, ve bunu üçe bölmek, birbirleriyle konuşmayan üç sistem izlenimi verir" },
    "a.push-approaching": { headline: "Randevunun yaklaştığını, tarih, saat, lokasyon veya katılım yoluyla birlikte söyle" },
    "w.24h": { headline: "randevudan sabit bir süre önceye kadar", detail: "zaman aşımı: Son hatırlatma, o andaki rezervasyon durumuna göre gönderilir. (yapılandırma: scheduling.pre_start_window)" },
    "c.still-active": { headline: "Randevu hâlâ aktif mi?", edges: [{ label: "Hayır", detail: "güncel durum, bu hatırlatmanın planlandığı rezervasyonla artık uyuşmuyor - iptal edildi, taşındı veya geçersiz kılındı" }, { label: "Evet", detail: "rezervasyon onaylı, kaydedilen zamanda, ve verilebilir durumda" }] },
    "a.sms-final": { headline: "Son hatırlatmayı gönder: zamanı, yeri veya katılım yolunu ve hâlâ eksik olan her şeyi belirt" },
    "c.ready": { headline: "Hazırlık tamam mı?", edges: [{ label: "Evet", detail: "müşterinin borçlu olduğu her ön koşul karşılanmış olarak kaydedildi" }, { label: "Hayır", detail: "son hatırlatmadan sonra müşterinin borçlu olduğu en az bir ön koşul hâlâ eksik" }] },
    "a.email-final": { headline: "Hâlâ eksik olan tek şeyi ve hâlâ yapılabileceği son noktayı belirt. Onaylanmış zaman burada değiştirilmez - bir ön koşulun eksik olması birini uyarmak için bir sebeptir, planlanmış bir taahhüdü yeniden yazmak için değil" },
    "x.ready": { headline: "hazır", detail: "randevudan önce hazırlık tamamlandı" },
    "x.not-ready": { headline: "hazır değil", detail: "son hatırlatmadan sonra bir ön koşul hâlâ eksik" },
    "x.superseded": { headline: "geçersiz kılındı; son hatırlatma vadesi gelmeden rezervasyon değişti", detail: "yerine geçen rezervasyon, kendi hazırlığını kendi onayından yürütür" },
  },
  },
  "SCH-282": {
  shortName: "Müsaitlik Arama Terki",
  name: "Müsaitlik arandı, rezervasyon yapılmadı → tam slot, en yakın pencere veya bekleme listesi",
  ...
  nodes: {
    ...
    "w.settle": { headline: "1-2 saat bekle", detail: "zaman aşımı: İlk temas, sorgudan sonra istenmemiş bir rezervasyonun şansı olacak kadar bekler, ama soru güncelliğini koruduğu süreden fazla değil. (yapılandırma: availability_searched.settle)" },
    ...
    "c.settled": { headline: "Bu sürede rezervasyon yaptı mı?", edges: [{ label: "İstenmeden rezerve edildi", detail: "kişi, pencere için kendi başına bir rezervasyon yaptı veya tutma aldı" }, { label: "Henüz değil", detail: "bu kişi için pencereye dair bir rezervasyon ya da tutma kaydı yok" }] },
    ...
    "c.exact-available": { headline: "Aradığı zaman aralığında hâlâ müsait slot var mı?", edges: [{ label: "Evet", detail: "sorgunun sorduğu tam pencerede kapasite var, sistem kaydından yeniden okunmuş - sorgu anında gösterilen hiçbir şey hiçbir zaman tutulmadı" }, { label: "Hayır", detail: "tam pencere kalmadı" }] },
    "a.push-exact": { headline: "Push ile aradığın saat için hâlâ müsaitlik olduğunu söyle, rezervasyona doğrudan bir dönüş yoluyla birlikte. Pencerenin tutulduğuna dair hiçbir iddiada bulunma" },
    "c.push-booked": { headline: "Rezervasyon yaptı mı?", edges: [{ label: "Evet", detail: "bu kişi için pencereye dair yetkili bir rezervasyon ya da tutma kaydı var" }, { label: "Hayır", detail: "böyle bir kayıt yok" }] },
    "c.near-available": { headline: "En yakın alternatif zaman var mı?", edges: [{ label: "Evet", detail: "aynı ihtiyacı karşılayacak kadar talep edilene yakın bir kapasite var, sistem kaydından yeniden okunmuş" }, { label: "Hayır", detail: "hiçbir pencere talebi karşılamıyor" }] },
    "a.email-alternative": { headline: "E-posta ile sana uygun alternatif saatler olduğunu söyle: iki ya da üç alternatif slot, talep edilenden farklı olarak etiketlenmiş, rezervasyon yoluyla birlikte. Hiçbir şeyin tutulmadığını açıkça belirt" },
    "w.respond-email": { headline: "1 gün bekle", detail: "zaman aşımı: Alternatif teklife, akışın müsaitliği yeniden okuyup bekleme listesine geçmeden önce sabit bir süre tanınır. (yapılandırma: availability_searched.respond)" },
    "c.waitlist-check": { headline: "Bekleme listesi mümkün mü?", edges: [{ label: "Evet", detail: "kaynak bir bekleme listesini destekliyor" }, { label: "Hayır", detail: "kişiyi koyacak hiçbir şey yok" }] },
    "a.waitlist": { headline: "SMS ile bir bekleme listesi yeri olduğunu söyle, kısa ve net bir harekete geçirme çağrısıyla, ve bunun hiçbir şey rezerve etmediğini açıkça belirt. Sahip olmadığı bir yere sahip olduğuna inanan biri buna göre plan yapar, ve bu, hiçbir şeyin olmadığının söylenmesinden daha kötü bir sonuçtur" },
  ...
  name: "Yenileme penceresi → otomatik yenileme durumu ayrımı → yenilendi, yönlendirildi veya düştü",
  purpose: "Bir sonraki dönem hakkında, o dönemi gerçek kılan hiçbir şeyden ayrı, kendi başına bir karara varmak.",
  nodes: {
    "t.window": { headline: "Yenileme karar penceresi açılır", detail: "Dönem bitişinden önce sabit bir süre açılır - hangi kol işlerse işlesin, kendi hatırlatma dizisinin dönem bitmeden tamamlanabilmesi için yeterince erken." },
    "a.evaluate": { headline: "İlişkinin güncel durumunu, otomatik mi yoksa açık bir yenileme mi gerektirdiğini, uygulanacak yenileme koşullarını ve gerekli bildirimi, ve akışın geri saydığı dönem bitişini değerlendir" },
    ...
    "w.lead": { headline: "yetkili bir yenileme kararı kaydedilene kadar", detail: "zaman aşımı süresi: Hatırlatma dizisi, dönem bitişinden önce sabit bir süre başlar - her iki kolun da kendi dokunuşlarını dönem bitmeden tamamlayabilmesi için yeterli. (önerilen: dönem bitişinden 30 gün önce; yapılandır: renewal.cascade_lead_time)" },
    "c.auto-renew": { headline: "Bu ilişki için otomatik yenileme açık mı?", edges: [{ label: "Otomatik yenileme açık", detail: "ilişkinin yenileme modeli otomatik yenilemeye ayarlı" }, { label: "Otomatik yenileme kapalı", detail: "ilişki, karşı taraftan açık bir yenileme gerektiriyor" }] },
    "a.notice-auto": { headline: "İlişkinin dönem bitişinde otomatik olarak yenileneceğini bildir: yeni dönemin fiyatını, planı, kayıtlı ödeme yöntemini ve değişiklik yapmak için bir bağlantıyı" },
    "w.left1": { headline: "yetkili bir yenileme kararı kaydedilene kadar", detail: "zaman aşımı süresi: Otomatik yenileme bildiriminden sonra, ilişkinin hâlâ otomatik yenilenip yenilenmediği yeniden kontrol edilmeden önce, dönem bitişinden önce sabit bir süre. (önerilen: dönem bitişinden 7 gün önce; yapılandır: renewal.left_recheck)" },
    "c.cancel-or-change": { headline: "Kullanıcı, otomatik yenileme bildiriminden bu yana iptal etti mi ya da planını değiştirdi mi?", edges: [{ label: "İptal etti", detail: "karşı taraf, otomatik yenileme yürürlüğe girmeden önce iptal etti" }, { label: "Plan değiştirdi", detail: "karşı taraf, otomatik yenilemeyi onaylamak veya iptal etmek yerine bir plan veya koşul değişikliği talep etti" }, { label: "Hiçbiri", detail: "otomatik yenileme bildiriminden bu yana kayıtlı bir iptal veya değişiklik yok" }] },
    "a.non-renew": { headline: "Otomatik yenileme yürürlüğe girmeden önce iptal edildiği için, yürürlük bitişini mevcut dönemin bitişi olacak şekilde NON_RENEWING olarak kaydet. İlişki hâlâ aktiftir ve hâlâ mevcut dönemine tabidir - yenilememe, bir sonraki dönem hakkında bir karardır ve bu dönem hakkında hiçbir şey söylemez" },
    ...
    "a.change-requested": { headline: "Karşı tarafın otomatik yenilemeyi onaylamak veya iptal etmek yerine bir plan veya koşul değişikliği talep ettiğini, talebin hangi ilişki sürümüne karşı yetkilendirildiğiyle birlikte kaydet" },
    "h.change": { headline: "Plan veya koşul değişikliği talebi → doğrulama → planlama, uygulama veya ret", detail: "bir otomatik yenilemeyi onaylamak veya iptal etmek yerine talep edilen bir plan veya koşul değişikliği" },
    "a.push-approaching": { headline: "Yenileme tarihinin yaklaştığını bildir" },
    "w.left2": { headline: "yetkili bir yenileme kararı kaydedilene kadar", detail: "zaman aşımı süresi: Yaklaşan bildirim gönderildikten sonra, bekleme dönem bitişinin kendisinde sona erer. (önerilen: dönem bitişinin kendisi, başka bir öncü süre olmadan; yapılandır: renewal.term_end)" },
    "a.decided": { headline: "Yenilemeyi, yeni dönemin tarihleri ve uygulanacak koşullarla birlikte karara bağlanmış olarak kaydet; buraya, dönem bitişine otomatik yenileme hâlâ geçerliyken ve son kontrolden bu yana hiçbir şey değişmemişken ulaşıldı. Karara bağlanmış, yenilenmiş demek değildir - yeni dönem SUB-164'ün kendi koşulları sağlanana kadar var olmaz ve bir ilişki burada beklerken yine de sona erebilir" },
    ...
    "a.invite": { headline: "Üyeliği yenilemek isteyip istemediğini sor: kalan süreyi, yeni dönemin avantajlarını, fiyatı ve yenilemeye yönelik bir eylem çağrısını. Sormak karar vermek değildir - gönderilen bir yenileme daveti bir iletişimdir ve göndermeyi yanıt sayan bir uygulama, kimsenin onay vermediği bir ilişkiyi yeniler" },
    "w.right1": { headline: "yetkili bir yenileme kararı kaydedilene kadar", detail: "zaman aşımı süresi: Yenileme davetinden sonra, yenileyip yenilemediklerinin kontrol edilmesinden önce sabit bir süre. (önerilen: davetten 7 gün sonra; yapılandır: renewal.right_first_window)" },
    "c.renewed1": { headline: "Yenilediler mi?", edges: [{ label: "Evet", detail: "davet gönderildiğinden bu yana bir yenileme kaydedildi" }, { label: "Hayır", detail: "davet gönderildiğinden bu yana kayıtlı bir yenileme yok" }] },
    "x.renewed": { headline: "dönem bitmeden yenilendi", detail: "bir sonraki dönemin kendi yenileme döngüsü, sıra kendi dönem bitişine geldiğinde kendi örneğini açar" },
    "a.push-ending": { headline: "Üyeliğin bitmesine az kaldığını bildir" },
    "w.right2": { headline: "yetkili bir yenileme kararı kaydedilene kadar", detail: "zaman aşımı süresi: Bitişe yakın bildirimden sonra, yeniden yenileyip yenilemediklerinin kontrol edilmesinden önce, dönem bitişinden önce kısa, sabit bir süre. (önerilen: dönem bitişinden 1-2 gün önce; yapılandır: renewal.right_second_window)" },
    "c.renewed2": { headline: "Yenilediler mi?", edges: [{ label: "Evet", detail: "bitişe yakın bildirimden bu yana bir yenileme kaydedildi" }, { label: "Hayır", detail: "bitişe yakın bildirimden bu yana kayıtlı bir yenileme yok" }] },
    "a.whatsapp-final": { headline: "Son bir yenileme hatırlatması gönder" },
    "w.right3": { headline: "yetkili bir yenileme kararı kaydedilene kadar", detail: "zaman aşımı süresi: Bekleme, son hatırlatma zaten gönderilmişken, dönem bitişi geçtiğinde sona erer. (önerilen: dönem bitişinin geçmiş olması, başka bir hatırlatma borcu kalmadan; yapılandır: renewal.right_final_window)" },
    "c.renewed3": { headline: "Yenilediler mi?", edges: [{ label: "Evet", detail: "son hatırlatmadan bu yana bir yenileme kaydedildi" }, { label: "Hayır", detail: "tüm hatırlatma dizisi boyunca hiçbir yerde bir yenileme kaydedilmedi" }] },
    "a.lapsed": { headline: "İlişkiyi, dönem sona ermiş ve tüm hatırlatma dizisi boyunca hiçbir yenileme kararı kaydedilmemiş olarak düşmüş kaydet" },
    "h.lapsed": { headline: "Ücretli ilişki sona erdi → iletişime izin verildi → geri kazanıldı, reddedildi ya da kendi haline bırakıldı", detail: "tam hatırlatma dizisinden sonra, hiçbir yenileme kararı kaydedilmeden dönem bitişine ulaşan, elle yenilenen bir ilişki" },
  },
  },
  "SUB-165": {
