...
const OVERRIDES: Readonly<Record<string, JourneyOverride>> = {
  ...
  nodes: {
    ...
    "x.cancellation-in-motion": { headline: "iptal niyeti kayıtlarda zaten var; ayrı bir elde tutma süreci açılmadı", detail: "askıda kalmış ya da terk edilmiş bir iptal, ya da karar sonuçlandığında yeni bir risk sinyali, bu değerlendirmeyi güncel kanıtlardan yeniden açar" },
    ...
    "a.check-in-email": { headline: "Yanlış giden neyi görebildiğimizi belirten ve bir kişiye ulaşma yolu sunan bir kontrol mesajı gönderin, üründe olmayan birine ulaşan rota üzerinden. Hiçbir teklif ya da indirim içermez; bu süreç hiçbir zaman teklif yapmaz" },
    "a.check-in-inapp": { headline: "Yanlış giden neyi görebildiğimizi belirten ve bir kişiye ulaşma yolu sunan bir kontrol mesajı gönderin, başarısız olan şeyin yanında, kişinin hâlâ bulunduğu yerde. Hiçbir teklif ya da indirim içermez; bu süreç hiçbir zaman teklif yapmaz" },
