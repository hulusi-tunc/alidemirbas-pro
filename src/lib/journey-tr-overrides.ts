...
const CATEGORY_TITLE_TR: Readonly<Record<string, string>> = {
  "Acquisition, intent & qualification": "Acquisition, niyet ve qualification",
  "Activation, onboarding & early value": "Activation, onboarding ve erken değer",
  ...
  "Entity merge, account closure, data lifecycle & terminal states": "Varlık birleştirme, hesap kapatma, data lifecycle ve nihai durumlar",
...
const OVERRIDES: Readonly<Record<string, JourneyOverride>> = {
  ...
  nodes: {
    ...
    "c.sendable": {
      ...
      edges: [
        { label: "Gönderilebilir", detail: "gönderim yolu geçiliyor: bu rezervasyona dair hizmet iletişimi izni, ulaşılabilir bir hedef, hizmet contact pressure sınıfı ve bu rezervasyonu şu anda tutan daha yüksek öncelikli bir rezervasyon-yaşam-döngüsü akışının bulunmaması" },
  ...
  nodes: {
    ...
    "c.sendable": {
      ...
      edges: [
        { label: "Gönderilebilir", detail: "zorunlu kontroller bu amaçla iletişime izin veriyor ve iletişim noktası ulaşılabilir durumda; bu mesaj kişiye borçlu olunduğu için contact pressure limiti uygulanmaz" },
  ...
  nodes: {
    ...
    "c.sendable": {
      ...
      edges: [
        { label: "Gönderilebilir", detail: "gönderim yolu geçiliyor: ticari iletişim izni, ulaşılabilir bir hedef, promosyon contact pressure limiti, bu kişiyi şu anda tutan daha yüksek öncelikli bir ticaret-kurtarma akışının bulunmaması ve yürürlükte bekleme süresi olmaması" },
        { label: "Engellendi", detail: "bir kapı akışı durduruyor; hangi kapının durdurduğu gerekçe olarak kaydedilir" },
      ],
    },
    "a.router1": {
  ...
  nodes: {
    ...
    "c.state": {
      ...
      edges: [
        { label: "Karşılama zamanı", detail: "ilk satın alma geçerli, ikinci bir satın alma kaydı yok ve lifecycle iletişimi izni hâlâ geçerli" },
    ...
    "c.sendable": {
      ...
      edges: [
        { label: "Gönderilebilir", detail: "gönderim kontrolleri geçiliyor: lifecycle iletişimi izni var, ulaşılabilir bir kanal var, contact pressure limiti aşılmadı ve kişiyi daha yüksek öncelikli bir journey tutmuyor" },
        { label: "Engellendi", detail: "bir kapı akışı durduruyor; hangi kapının durdurduğu gerekçe olarak kaydedilir" },
      ],
    },
    "a.welcome": {
    ...
    "x.prompted": {
      ...
      detail: "bu örnek yeniden açılmaz; teklifin kabul edilip edilmediğini gözlemek olağan lifecycle'ın işidir",
    },
    "x.closed": {
  ...
  nodes: {
    ...
    "c.sendable": {
      ...
      edges: [
        { label: "Gönderilebilir", detail: "gönderim yolu geçiliyor: ticari iletişim izni, ulaşılabilir bir hedef, promosyon contact pressure limiti, bu kişiyi şu anda tutan daha yüksek öncelikli bir teklif akışının bulunmaması ve yürürlükte bekleme süresi olmaması" },
        { label: "Engellendi", detail: "bir kapı akışı durduruyor; hangi kapının durdurduğu gerekçe olarak kaydedilir" },
      ],
    },
    "a.recommend": {
  ...
  nodes: {
    ...
    "c.sendable": {
      ...
      edges: [
        { label: "Gönderilebilir", detail: "gönderim yolu geçiliyor: ticari iletişim izni, ulaşılabilir bir hedef, promosyon contact pressure limiti, bu kişiyi şu anda tutan daha yüksek öncelikli bir akışın bulunmaması ve yürürlükte bekleme süresi olmaması" },
        { label: "Engellendi", detail: "bir kapı akışı durduruyor; hangi kapının durdurduğu gerekçe olarak kaydedilir" },
      ],
    },
    "a.offer": {
  ...
  nodes: {
    ...
    "c.date": {
      ...
      edges: [
        { label: "Kutla", detail: "tarih kişinin verdiği ya da kaydından türetilen bir tarih, ilişki açık, bu dönem daha önce kutlanmadı ve gönderim kontrolleri geçiliyor: amaç düzeyinde lifecycle izni var, ulaşılabilir bir kanal var, contact pressure limiti aşılmadı ve kişiyi daha yüksek öncelikli bir journey tutmuyor" },
  ...
  nodes: {
    ...
    "c.sendable": {
      headline: "Karşılama gönderilebilir mi?",
      edges: [
        { label: "Gönderilebilir", detail: "gönderim kontrolleri geçiliyor: lifecycle iletişimi izni var, ulaşılabilir bir kanal var, contact pressure limiti aşılmadı ve üyeliği daha yüksek öncelikli bir journey tutmuyor" },
  ...
  nodes: {
    ...
    "c.sendable": {
      ...
      edges: [
        { label: "Gönderilebilir", detail: "gönderim yolu geçiliyor: promosyon iletişimi izni, ulaşılabilir bir hedef, promosyon contact pressure limiti, bu üyeliği şu anda tutan daha yüksek öncelikli bir üyelik akışının bulunmaması ve yürürlükte bekleme süresi olmaması" },
        { label: "Engellendi", detail: "bir kapı durduruyor; hangi kapının durdurduğu gerekçe olarak kaydedilir" },
      ],
    },
    "a.explain": {
  ...
  nodes: {
    ...
    "c.sendable1": {
      ...
      edges: [
        { label: "Gönderilebilir", detail: "gönderim yolu geçiliyor: ticari kurtarma iletişimi izni, ulaşılabilir bir hedef, promosyon contact pressure limiti, yürürlükte bir cooldown olmaması ve ticaret-kurtarma çekişmesinde bu kişiyi şu anda daha yüksek öncelikli bir akışın tutmuyor olması" },
        { label: "Engellendi", detail: "bir kapı akışı durduruyor; hangi kapının durdurduğu gerekçe olarak kaydedilir" },
      ],
    },
  ...
  nodes: {
    ...
    "c.sendable1": {
      headline: "İlk hatırlatma gönderilebilir mi?",
      edges: [
        { label: "Gönderilebilir", detail: "gönderim yolu geçiliyor: ticari kurtarma iletişimi izni, ulaşılabilir bir hedef, promosyon contact pressure limiti, kişi üzerinde daha yüksek öncelikli bir çakışma olmaması ve yürürlükte bir cooldown olmaması" },
        { label: "Engellendi", detail: "bir kapı akışı durduruyor; hangi kapının durdurduğu gerekçe olarak kaydedilir" },
      ],
    },
    "a.record-no-action-t1": {
  ...
  "ACC-263": {
  shortName: "Etkinleştirme Hatırlatması",
  name: "Hak veya kimlik bilgisi verildi → etkinleştirme penceresi → etkinleştirildi veya kullanılmadan geçerliliğini yitirdi",
  purpose: "Birinin, kendisine verilen şeyi talep edebileceği pencere kapanmadan önce onu fiilen kullanmasını sağlamak - çünkü kullanılmamış bir hak, hiç verilmemiş bir haktan ayırt edilemez.",
  nodes: {
    "t.issued": { headline: "Hak sağlandı ve erişilebilir durumda" },
  ...
  purpose: "Anlamlı ama anonim bir niyet sinyalini, bir kimlik uydurmadan kimlik çözümleme sürecinden geçirmek ve lifecycle'a girişi, kimliğin çözülmüş olmasından ayrı bir soru olarak ele almak.",
  nodes: {
    "t.threshold": {
    ...
    "c.eligible": { headline: "Artık bilinen profil bir lifecycle'a girmeye uygun mu?", edges: [{ label: "Uygun", detail: "aday lifecycle'ın uygunluk kuralları birleştirilmiş profilde geçerli ve bu lifecycle'ın yapacağı şey için yasal bir dayanak mevcut" }, { label: "Uygun değil", detail: "uygunluk sağlanmıyor ya da iletişim için yasal bir dayanak yok - kimliğin çözüldüğü ama iznin hiç verilmediği sıradan durum dahil" }] },
    ...
    "x.known-only": { headline: "bilinen profil, lifecycle'a girilmedi", detail: "ACQ-06, altta yatan veri değiştiğinde uygunluğu yeniden değerlendirir; bilinir hale gelmek kendi başına nurture'ı başlatmaz" },
  },
  },
  "ACQ-02": {
  ...
  nodes: {
    ...
    "h.destination": { headline: "external:destination-lifecycle", detail: "girilebilir bir hedefle eşleşen, açıkça belirtilmiş bir talep" },
    "c.disqualifier": { headline: "Bu lead'i eleyen bir koşul var mı?", edges: [{ label: "Elendi", detail: "yetkili bir kural lead'i eliyor: hizmet verilen pazarın dışında, bir rakip, geçersiz iletişim bilgisi ya da bu kapsamda zaten aktif bir müşteri" }, { label: "Eleyen koşul yok", detail: "lead geçerli ancak henüz aksiyona hazır değil" }] },
    ...
    "h.education": { headline: "Lead Nurture → sınırlı temas → ilerleme veya çıkış", detail: "henüz aksiyona hazır olmayan geçerli bir lead" },
  },
  },
  "ACQ-03": {
  shortName: "Yüksek Niyet / Satışa Handoff",
  name: "Niyet yükselmesi → daha yüksek niyetli journey'ye handoff",
  purpose: "Düşük niyetli bir lifecycle'daki kişi daha güçlü bir sinyal verdiğinde sahipliği doğru journey'ye handoff etmek ve önceki journey'nin gönderimlerini durdurmak.",
  nodes: {
    ...
    "a.resolve": { headline: "Bu varlıkta kişiyi hangi journey'nin tuttuğunu ve yeni niyetin hangi lifecycle'a ait olduğunu belirle" },
    ...
    "c.higher": { headline: "Yeni niyet için daha yüksek öncelikli bir süreç var mı?", edges: [{ label: "Daha yüksek öncelikli süreç var", detail: "yeni niyet, mevcut sahibinden daha yüksek öncelikli bir lifecycle ile eşleşiyor" }, { label: "Daha yüksek yok", detail: "mevcut süreç, bu varlık için kayıtlı en güçlü niyeti zaten temsil ediyor" }] },
    "a.suppress": { headline: "Handoff tamamlanmadan önce önceki journey'nin kuyruktaki ve gönderim aşamasındaki mesajlarını suppression'a al" },
    ...
    "h.escalate": { headline: "external:higher-intent-lifecycle", detail: "bu varlık için niyet önemli ölçüde arttı" },
  },
  },
  "ACQ-04": {
  shortName: "Yüksek Niyetli Lead Routing",
  ...
  nodes: {
    ...
    "h.reached": { headline: "Ticari hedef tamamlandı → acquisition suppression → lifecycle handoff", detail: "hedef tamamlandıktan sonra gelen yüksek niyetli bir aksiyon" },
    ...
    "h.human": { headline: "external:human-in-the-loop-lifecycle", detail: "bir sonraki adımı artık atanmış bir sahibin yürütmesi" },
  },
  },
  "ACQ-05": {
  ...
  nodes: {
    ...
    "w.recycle": { headline: "lead için kaydedilen yeniden giriş koşulu veya tarihi gelene kadar", detail: "Yeniden değerlendirme, nedenle birlikte kaydedilen koşula veya tarihe bağlıdır; bekleme bu noktada sona erer ve sistem yeni bir tarih uydurmaz. (qualification_state.recycle ayarlanmalı)" },
  ...
  name: "Niyet zayıflaması → önceliği düşür → cooldown veya çıkış",
  ...
  nodes: {
    ...
    "h.customer": { headline: "external:customer-lifecycle", detail: "aktif bir müşteri ilişkisi üzerinde zayıflayan kazanım niyeti" },
    "w.cooldown": { headline: "niyeti yeniden açacak kadar güçlü yeni bir davranış sinyali gelene kadar", detail: "Bu niyet bağlamında cooldown işler. Süre içinde gelen güçlü bir sinyal niyeti yeniden yükseltir; süre dolarsa zayıflayan niyet karar kaydı oluşturmadan kapanır. (intent_decay.cooldown ayarlanmalı)" },
    "h.re-escalate": { headline: "Niyet yükselmesi → daha yüksek niyetli journey'ye handoff", detail: "cooldown sırasında gelen yeni ve güçlü bir sinyal" },
  ...
  name: "Ticari hedef tamamlandı → acquisition suppression → lifecycle handoff",
  ...
  nodes: {
    ...
    "h.next": { headline: "external:next-lifecycle", detail: "hedef durumun kaydedilmesi" },
  },
  },
  "ACQ-09": {
  shortName: "Lead Nurture",
  name: "Lead henüz hazır değil → sınırlı nurture → ilerleme veya çıkış",
  purpose: "Geçerli ancak henüz aksiyona hazır olmayan bir lead'e, süresi ve temas sayısı baştan belirlenmiş bir nurture akışı sunmak.",
  nodes: {
    "t.not-ready": { headline: "Lead henüz aksiyona hazır değil" },
    ...
    "w.first": { headline: "lead ilerleme sinyali verene, izin geri çekilene veya izinli hiçbir kanala ulaşılamayana kadar", detail: "İlk ve son temas arasındaki süre, ilk mesajın değerlendirilebileceği kadar uzun; journey penceresini aşmayacak kadar kısa olmalıdır." },
    "c.still-open": { headline: "Lead hâlâ aynı nurture kapsamında mı?", edges: [{ label: "İlerledi", detail: "ilk temastan bu yana ilerleme sinyali kaydedildi; son temas gönderilmez" }, { label: "İzin geri çekildi", detail: "nurture'ın dayandığı yasal dayanak veya izin artık geçerli değil" }, { label: "Ulaşılabilir kanal yok", detail: "bu kişi için izinli ve ulaşılabilir bir kanal kalmadı" }, { label: "Hâlâ hazır değil", detail: "ilerleme kaydedilmedi, giriş nedeni hâlâ geçerli, izin devam ediyor ve ulaşılabilir bir kanal var" }] },
    ...
    "w.window": { headline: "lead yanıt, talep veya satın alma adımıyla ilerleyene; izin geri çekilene ya da izinli hiçbir kanala ulaşılamayana kadar", detail: "Nurture penceresi journey girişinde sabitlenir ve etkileşim olsa da uzamaz. Süre dolduğunda journey kapanır. (bounded_education.window ayarlanmalı)" },
    "c.window-event": { headline: "Beklemeyi ne sonlandırdı?", edges: [{ label: "İlerleme kaydetti", detail: "anlamlı bir ilerleme sinyali geldi" }, { label: "İzin geri çekildi", detail: "bu beslemenin dayandığı yasal dayanak veya izin artık bunu kapsamıyor" }, { label: "Ulaşım yolu kayboldu", detail: "bu kişi için izinli hiçbir hedefe artık ulaşılamıyor" }] },
    ...
    "a.stop-contactability": { headline: "Nurture'ı ilgisizlik olarak işaretlemeden durdur. Kanalın çalışmaması, lead'in ilgisini kaybettiği anlamına gelmez" },
  ...
  name: "Açık ticari ret → gerekçe → kapat, cooldown'a al veya yeniden değerlendir",
  ...
  nodes: {
    ...
    "h.decay": { headline: "Niyet zayıflaması → önceliği düşür → cooldown veya çıkış", detail: "bir karar yerine sessizlik nedeniyle kapatılan bir fırsat" },
    "h.classify": { headline: "Karar talebi → doğrula → yönlendir, reddet veya beklet", detail: "OTHER olarak kaydedilen bir ret" },
    "w.reentry": { headline: "lead için kaydedilen yeniden giriş koşulu veya tarihi gelene kadar", detail: "Bekleme; ret nedeniyle birlikte kaydedilen event, tarih veya koşul gerçekleştiğinde sona erer. Hiçbiri bilinmiyorsa yeni temas planlanmaz. (commercial_decline.reentry ayarlanmalı)" },
  ...
  nodes: {
    ...
    "x.no-action": { headline: "hiçbir temas gönderilmedi; bunu durduran engel kaydedildi", detail: "yeni bir mantıksal süreç yeni bir örnektir; bu süreç sona erdiğinde veya baskılandığında aktif cooldown'a tabidir" },
    ...
    "c.sendable": { headline: "İlk temas gönderilebilir mi?", edges: [{ label: "Gönderilebilir", detail: "gönderim yolu geçerli: ticari kurtarma izni var, ulaşılabilir bir hedef var, promosyon contact pressure limiti aşılmadı, hesapta daha yüksek öncelikli bir çakışma yok ve yürürlükte bir cooldown yok" }, { label: "Gönderilmez", detail: "suppression gerekçesi kaydedilir" }] },
    ...
    "c.sendable2": { headline: "İkinci temas gönderilebilir mi?", edges: [{ label: "Gönderilebilir", detail: "gönderim yolu geçerli ve temas bütçesi tükenmedi" }, { label: "Gönderilmez", detail: "suppression gerekçesi kaydedilir" }] },
    ...
    "x.lapsed": { headline: "kurtarma süresi, süreç hâlâ açıkken doldu; başka hiçbir şey gönderilmez", detail: "yeni bir mantıksal süreç yeni bir örnektir ve cooldown işlerken sessizce başlar" },
  ...
  nodes: {
    ...
    "x.no-action": { headline: "hiçbir temas gönderilmedi; bunu durduran engel kaydedildi", detail: "yeni bir seçim yeni bir örnektir; bu seçim sona erdiğinde veya baskılandığında aktif cooldown'a tabidir" },
    ...
    "c.sendable": { headline: "İlk temas gönderilebilir mi?", edges: [{ label: "Gönderilebilir", detail: "gönderim yolu geçerli: ticari kurtarma izni var, ulaşılabilir bir hedef var, promosyon contact pressure limiti aşılmadı, kişi üzerinde daha yüksek öncelikli bir çakışma yok ve yürürlükte bir cooldown yok" }, { label: "Gönderilmez", detail: "suppression gerekçesi kaydedilir" }] },
    ...
    "x.lapsed": { headline: "kurtarma süresi, seçim hâlâ dururken doldu; başka hiçbir şey gönderilmez", detail: "yeni bir seçim yeni bir örnektir ve cooldown işlerken sessizce başlar" },
  },
  },
  "ACQ-13": {
  ...
  nodes: {
    ...
    "x.resolved": { headline: "çözümlendi; konu için bir seçim, süreç veya satın alma kaydedildi ve bunu kendi süreci yürütüyor", detail: "yeni bir ilgi anahtarı yeni bir ilgidir" },
    ...
    "w.settle": { headline: "kişiye karşı bir süreç başlatılmadan sistem kaydında bir seçim kaydedilene kadar, ya da en az bir ürün ve sürdürülebilir bir durumla bir kişi için sürdürülebilir bir sürecin (ödeme, başvuru, teklif, kayıt) açıldığına dair yetkili bir kayıt oluşana kadar, ya da kişi için herhangi bir konuda yetkili bir satın alma gerçekleşene kadar", detail: "Temas, kişinin konuda duraklamadığından, gerçekten ayrıldığından emin olacak kadar - ama ilgi tazeliğini yitirmeden önce - son ilgiden sonra bekler. (örnek: 12–48 saat; interest.settle_window ayarlanmalı)" },
    "x.no-action": { headline: "hiçbir temas gönderilmedi; neden kaydedildi - bu sürecin sık görülen sonucu", detail: "aynı ilgi anahtarının cooldown içinde yeniden yeterli bulunması aynı ilgidir; yeni bir anahtar yeni bir ilgidir" },
    ...
    "x.lapsed": { headline: "bir kez temas edildi, çözümlenmedi; başka hiçbir şey gönderilmez", detail: "yeni bir ilgi anahtarı yeni bir ilgidir ve cooldown işlerken sessizce başlar" },
  },
  },
  "ACQ-285": {
  shortName: "Yeni Lead Karşılama",
  ...
  nodes: {
    ...
    "c.still-open": {
      headline: "Bu hâlâ hiçbir şey belirtmemiş bir lead mi?",
      edges: [
  ...
  nodes: {
    "t.entry": { headline: "Yetkili lifecycle girişi" },
    ...
    "h.progress": { headline: "Onboarding ilerlemesi → sıradaki en iyi kurulum adımı → aktivasyon", detail: "bir rota seçildi ve başlangıcı engelleyen bir şey yok" },
  },
  },
  "ACT-12": {
  shortName: "Onboarding Besleme",
  name: "Onboarding ilerlemesi → sıradaki en iyi kurulum adımı → aktivasyon",
  ...
  nodes: {
    ...
    "w.progress": { headline: "ürünün kendi kaydı bir kurulum kilometre taşını tamamlanmış olarak işaretleyene veya bu onboarding için yetkili aktivasyon olayı kaydedilene kadar", detail: "zaman aşımı: Adım hatırlatmaları arasındaki süre, kalan işe uygun olmalıdır - dakikalar süren bir adım ile bir yönetici gerektiren bir adım aynı süreyi paylaşamaz. (onboarding.step_interval üzerinden yapılandırılır)" },
    "h.activated": { headline: "Aktivasyona ulaşıldı → onboarding'i durdur → benimseme devri", detail: "yetkili aktivasyon olayı" },
    "c.what-happened": { headline: "Hangi olay geldi?", edges: [{ label: "Aktivasyon", detail: "yetkili aktivasyon olayı kaydedildi" }, { label: "Bir kurulum kilometre taşı", detail: "ilerleme kaydedildi ama henüz değer üretilmedi" }] },
    "c.window": { headline: "Onboarding penceresi hâlâ açık mı?", edges: [{ label: "Hâlâ açık", detail: "girişte belirlenen pencere henüz dolmadı" }, { label: "Kapandı", detail: "pencere aktivasyon olmadan doldu" }] },
  ...
  nodes: {
    ...
    "h.escalate": { headline: "external:human-in-the-loop-lifecycle", detail: "çözüm ufkunu aşan bir engel" },
    ...
    "h.resume": { headline: "Onboarding ilerlemesi → sıradaki en iyi kurulum adımı → aktivasyon", detail: "engel kalktı ve aktivasyona yeniden ulaşılabilir" },
  ...
  nodes: {
    ...
    "x.normal": { headline: "kurtarma girişimi kapandı, olağan lifecycle devam ediyor", detail: "bekleme süresinden sonra, açık ve aktifleşmemiş bir örnekte yaşanan yeni bir zorlanma" },
  ...
  nodes: {
    ...
    "a.spin-off": { headline: "Bekleyen operasyonel gereksinimi kendi lifecycle'ına handoff et. Bu, onboarding'i açık tutmaz ve onboarding onun adına mesaj göndermeye devam etmez" },
  ...
  "ACT-18": {
  shortName: "Benimseme Kurtarma",
  name: "Benimseme durması → eksik değeri teşhis et → kurtar veya yeniden yönlendir",
  purpose: "Herhangi bir şey yapmadan önce değerin neden tekrarlanmayı bıraktığını anla; hiçbir sorun olmama ihtimalini de dahil ederek.",
  nodes: {
    "t.stall": { headline: "Beklenen benimseme örüntüsü karşılanmadı" },
    "a.diagnose": { headline: "Kanıtın fiilen ne gösterdiğini belirle: hiç tamamlanmamış bir kurulum, eksik bir entegrasyon, net olmayan bir sonraki kullanım senaryosu, hiç katılmamış paydaşlar, bir daha tekrarlanmamış değer, teknik bir engel - ya da tamamlanmış ve başka bir şeye ihtiyaç duymayan bir kullanım senaryosu" },
    "c.type": { headline: "Kanıt ne gösteriyor?", edges: [{ label: "Kurtarılabilir engel", detail: "somut bir şey engel oluşturuyor: tamamlanmamış kurulum, eksik bir entegrasyon, net olmayan bir sonraki kullanım senaryosu, hiç katılmamış paydaşlar" }, { label: "Bir kişi gerekiyor", detail: "bir mesajla çözülemeyecek teknik bir sorun" }, { label: "İhtiyaç gerçekten karşılandı", detail: "kullanım senaryosu tamamlandı ve yapılacak başka bir şey yok - hesap aradığını buldu" }, { label: "Sorun olduğuna dair kanıt yok", detail: "kullanım, genel bir beklentiye göre düşük görünüyor ama bir sorun olduğuna dair hiçbir işaret yok" }] },
    "a.recover": { headline: "Teşhis edilen engeli doğrudan ele al. Daha fazla teşvik değil, onboarding'i yeniden başlatmak değil - teşhisin fiilen adını koyduğu şey" },
    "h.assistance": { headline: "external:human-in-the-loop-lifecycle", detail: "bir kişi gerektiren teknik bir engel" },
    "x.satisfied": { headline: "kullanım senaryosu tamamlandı; ihtiyaç terk edilmedi, karşılandı", detail: "yeni bir kullanım senaryosu, ya da aynı ihtiyacın yeniden ortaya çıkması, benimsemeyi normal şekilde yeniden açar - bu hesap başarısız olmadı, işini bitirdi" },
    "x.no-intervention": { headline: "sorun bulunamadı; hiçbir şey gönderilmedi", detail: "gerçek bir durma kanıtı ileride bunu yeniden açar - bir bulgunun yokluğu da bir bulgudur ve bundan yapay bir müdahale üretmek, bu dalın önlemeye çalıştığı hatadır" },
    "w.recover": { headline: "ürün, kişinin bu kullanım senaryosunda tekrar değer ürettiğini kaydedene kadar", detail: "zaman aşımı: Kurtarma penceresi, ürünün bu kullanım senaryosu için öngördüğü kullanım ritminden türetilir ve sınırlıdır; bir durma ya kurtarılır ya da izlemeye devredilir - asla sonsuza kadar hatırlatılmaz. (adoption_recovery.window üzerinden yapılandırılır)" },
    "h.adoption": { headline: "Erken benimseme → kullanım derinliği → alışkanlık veya kararlı kullanım", detail: "kurtarmanın ardından değer yeniden üretildi" },
    "h.monitor": { headline: "external:health-monitoring", detail: "değer geri dönmeden kurtarma penceresinin kapanması" },
  },
  },
  "ACT-19": {
  ...
  nodes: {
    ...
    "h.onboarding": { headline: "Onboarding ilerlemesi → sıradaki en iyi kurulum adımı → aktivasyon", detail: "tamamlanmamış kuruluma geri dönüş" },
  ...
  name: "İş event'i → iletişim yükümlülüğü → oluştur veya suppression uygula",
  purpose: "Herhangi bir mesaj var olmadan önce, olan bitenle ilgili gerçekten birine borçlu olunup olunmadığına karar ver.",
  nodes: {
    "t.event": { headline: "Yetkili iş event'i" },
    "a.evaluate": { headline: "Event türünü, alıcıyı, iletişim gerekliliğini, amacı, aciliyeti, güncel state'i, bekleyen eşdeğer iletişimi ve geçerli gönderim kurallarını değerlendir" },
    "c.required": { headline: "Bu event ve alıcı için iletişim yükümlülüğü var mı?", edges: [{ label: "Var", detail: "bir kural, sözleşme veya tanımlı beklenti bu alıcıya mesaj gönderilmesini gerektiriyor" }, { label: "Yok", detail: "bu alıcıya event hakkında bilgi verilmesini gerektiren bir kural yok" }] },
  ...
  nodes: {
    ...
    "h.permission": { headline: "İletişim amacı → izin ve tercih kontrolü → gönder, suppression uygula veya alternatif kullan", detail: "kullanılabilir kanalları olan, çözümlenmiş bir alıcı" },
  ...
  name: "İletişim amacı → izin ve tercih kontrolü → gönder, suppression uygula veya alternatif kullan",
  ...
  nodes: {
    ...
    "a.purpose": { headline: "İletişimin amacını sınıflandır: işlemsel, güvenlik, hizmet, zorunlu bildirim, operasyonel, pazarlama veya tanımlı başka bir amaç. Uygulanacak izin ve suppression kurallarını bu sınıf belirler" },
    "a.evaluate": { headline: "Geçerli izni, onayı, kanal tercihini, zorunlu teslim kurallarını ve suppression state'ini iletişim amacına göre değerlendir. Suppression gönderen tarafta tutuluyorsa izin hâlâ açık olsa bile tanıtım ve lifecycle mesajlarını engeller; hizmet, işlemsel, güvenlik ve zorunlu iletişim kendi kurallarıyla devam eder" },
    ...
    "a.candidates": { headline: "Bu amaç için izin verilen kanalları ve her kanala izin veren kuralı kaydet. Böylece hem gönderim hem suppression kararı açıklanabilir kalır" },
  ...
  nodes: {
    ...
    "h.send-ready": { headline: "Mesaj hazırlandı → state'i yeniden doğrula → gönder veya suppression uygula", detail: "seçilmiş kanala göre hazırlanmış bir mesaj" },
  },
  },
  "CMS-205": {
  shortName: "Gönderim Uygunluğu Kontrolü",
  name: "Mesaj hazırlandı → state'i yeniden doğrula → gönder veya suppression uygula",
  ...
  nodes: {
    ...
    "a.suppress": { headline: "Güncelliğini yitirmiş mesajı suppression'a al ve gerekçeyi kaydet. İptal edilen randevu için hatırlatma ya da tamamlanan ödeme için hata bildirimi gönderme" },
    ...
    "x.suppressed": { headline: "güncelliğini yitirmiş mesaj suppression'a alındı; gönderim yapılmadı", detail: "yükümlülük tamamlandı olarak değil, yerine yenisi geçti olarak kapanır. Aynı konudaki yeni bir event kendi yükümlülüğünü oluşturur" },
  ...
  nodes: {
    ...
    "x.duplicate-event": { headline: "yinelenen teslim olayı yok sayıldı; kayıtlı durum değişmedi", detail: "bu deneme için gerçekten yeni bir sonuç kendi koşullarında işlenir. Kanallar webhook'ları tekrarlar ve durum değişikliğini onlarla birlikte tekrarlamak her teslimi iki kez saymak anlamına gelir" },
  ...
  "CON-272": {
  shortName: "İletişim Noktası Kurtarma",
  name: "İletişim noktasına ulaşılamıyor → alternatif rota → düzeltildi veya durduruldu",
  ...
  nodes: {
    ...
    "h.human": { headline: "external:human-in-the-loop-lifecycle", detail: "teslim edilecek izinli bir yolu olmayan önemli bir iletişim" },
  ...
  name: "Suppression → gerekçe ve kapsam → kaldır veya sürdür",
  purpose: "Bir gönderimin neden engellendiğini açık, kapsamı belli ve kaldırılabilir bir state olarak kaydetmek.",
  nodes: {
    "t.suppression": { headline: "Suppression koşulu aktif oldu" },
    "a.record": { headline: "Suppression gerekçesini, kapsamını, kaynağını, başlangıç zamanını ve varsa kaldırma koşulunu kaydet" },
    "c.kind": { headline: "Suppression'ın tanımlı bir kaldırma koşulu var mı?", edges: [{ label: "Geçici", detail: "belirli bir süre, event, frequency penceresi veya kapanan bir vaka suppression'ı kaldıracak" }, { label: "Kalıcı", detail: "izin geri çekme, yasal kısıtlama veya geçersiz iletişim noktası gibi yetkili state değişene kadar sürer" }] },
    "w.release": { headline: "suppression'ı kaldıracak koşul gerçekleşene kadar", detail: "timeout: gerekçeye uygun review süresinin ardından. (communication_suppression.release ayarlanmalı)" },
    "x.persistent": { headline: "temel state değişene kadar suppression devam eder", detail: "koşul değiştiğinde yeni bir değerlendirme açılır; kişi ve geçmiş kayıtları korunur, yalnızca gönderim engellenir" },
    "a.reevaluate": { headline: "Etkilenen journey'lerin güncel state'e göre ne yapması gerektiğini yeniden değerlendir. Suppression sırasında bekleyen mesajları sonradan toplu göndermeden iptal et" },
    "c.still": { headline: "Suppression gerekçesi hâlâ geçerli mi?", edges: [{ label: "Hâlâ geçerli", detail: "suppression'a neden olan koşul devam ediyor" }, { label: "Artık geçerli değil", detail: "kaldırma event'i gelmese de gerekçe geçerliliğini yitirdi" }] },
    "x.released": { headline: "suppression kaldırıldı; güncel uygunluk yeniden hesaplandı, bekleyen mesajlar iptal edildi", detail: "yeni bir suppression koşulu kendi gerekçesi ve kapsamıyla yeni bir instance açar" },
  },
  },
  "CON-39": {
  ...
  nodes: {
    "t.cooldown": { headline: "Cooldown'u başlatan event" },
    ...
    "w.cooldown": { headline: "cooldown'u oluşturan koşul değişene kadar", detail: "timeout: cooldown süresi dolduğunda" },
    ...
    "h.suppression": { headline: "Suppression → gerekçe ve kapsam → kaldır veya sürdür", detail: "gerekçesini aşan bir cooldown" },
    "x.released": { headline: "cooldown sona erdi; uygunluk yeniden hesaplandı, bekleyen mesajlar iptal edildi", detail: "cooldown'u tetikleyen yeni bir event, kendi gerekçesi ve kapsamıyla yeni bir instance açar" },
  },
  },
  "CON-40": {
  ...
  "DOC-214": {
  shortName: "Belge Teslimi",
  name: "Belge dağıtımı → gönder veya erişim sağla → onayla veya başarısız ol",
  purpose: "Yayımlanmış belirli bir sürümü, sahibi olması gereken tarafa ulaştırmak - teslimat durumu ile belgenin geçerliliğinin birbirini etkilemesine izin vermeden.",
  nodes: {
    "t.requires": { headline: "Yayımlanan belge dağıtım gerektiriyor" },
    "a.recipient": { headline: "Hedeflenen alıcıyı ve bu tür bir belge için izin verilen dağıtım yolunu belirle. Bir belgenin yanlış tarafa ulaşması, hiç gönderilmemesinden daha kötüdür - ikincisi yeniden denenebilir, birincisi geri çağrılamaz" },
    "a.version": { headline: "Dağıtımı, yayımlanan tam sürüme bağla. Güncelliğini yitirmiş bir sürümün gönderilmesi, bu adımın önlemek için var olduğu hatadır: alıcı, artık kimsenin sunmadığı şartları elinde bulundurur, onlara güvenir ve hatta imzalayabilir" },
    "a.distribute": { headline: "Gerçek teslimatı, kanalları, izinleri, yeniden denemeleri ve teslimat kanıtını yöneten kurallı iletişim mekanizması üzerinden başlat. Belge dağıtımı kendi teslimat yolunu oluşturmaz - paralel bir yol, sözleşmenin gerçekten gönderilip gönderilmediği konusunda kurallı teslimat kaydıyla çelişir" },
    "w.distribution": { headline: "dağıtım gerekli düzeyde onaylanana veya dağıtım başarısız olana kadar", detail: "zaman aşımı: Dağıtım sonucu, iletişim mekanizmasının kendi teslimat penceresi boyunca beklenir; bu sürenin ötesinde sonuç varsayılmaz, mutabakata tabi tutulur. (yapılandırma: document_distribution.distribution)" },
    "c.outcome": { headline: "Dağıtım nasıl sonuçlandı?", edges: [{ label: "Onaylandı", detail: "teslimat veya erişilebilirlik, gereksinimin talep ettiği düzeyde kanıtlanır" }, { label: "Başarısız", detail: "kanal, ulaşmadığını kesin olarak bildirir" }] },
    "a.unknown": { headline: "Dağıtım sonucunu bilinmiyor olarak kaydet ve bunu teslim edilmiş sayma. Belgenin geçerliliği her iki durumda da etkilenmez - bilinmeyen tek şey, belgeye birinin sahip olup olmadığıdır" },
    "a.confirmed": { headline: "Dağıtılan tam sürüme karşı TESLİM EDİLDİ veya ERİŞİLEBİLİR durumunu kaydet. Teslimat durumu dağıtımı tanımlar, belgeyi asla tanımlamaz - teslim edilmemiş bir sözleşme, kimsenin elinde olmayan geçerli bir sözleşmedir; teslimatı geçerlilikle eş tutmak, bir posta hatasını hukuki bir soruna dönüştürür" },
    "h.recover": { headline: "Teslimat hatası → sınıflandır → yeniden dene, alternatif yola geç veya durdur", detail: "başarısız olmuş bir belge dağıtımı" },
    "h.reconcile": { headline: "external:external-status-reconciliation", detail: "sonucu belirlenemeyen bir dağıtım" },
    "x.distributed": { headline: "belirlenen sürüm, hedeflenen alıcıya ulaştı; bu durum belgenin geçerliliğini değiştirmez", detail: "yerini alan bir sürüm kendi dağıtımını gerektirir. Bu durum, önceki dağıtımdan hiçbir şeyi geçersiz kılmaz - alıcıya o sırada güncel olan şey doğru biçimde verilmiştir" },
  },
  },
  "DOC-215": {
  ...
  nodes: {
    ...
    "x.received": { headline: "geri bildirim alındı; ne anlama geldiğini FBK-43 belirler", detail: "bu sürecin görevi talep aşamasında sona erdi; gelen yanıtın kendi lifecycle'ı var" },
    "x.no-response": { headline: "soruldu, yanıt gelmedi", detail: "gelecekteki bir deneyim hakkında yeniden soru sorulabilir; burada hiçbir şey sinyal olarak kaydedilmez, çünkü sessizlik memnuniyetsizlik değildir ve sonraki hiçbir süreç bunu öyleymiş gibi okuyamaz" },
  },
  },
  "FBK-42": {
  ...
  nodes: {
    ...
    "a.obligation": { headline: "Sahip süreçte iş kalemini, iki kaydın bağlantılı kalması için geri bildirim kayıt kimliğiyle oluştur. Bu noktadan itibaren sorunun kendi lifecycle'ı ve sahibi vardır; kayıt bağımsız olarak açık kalır çünkü sorunun kapanması ile kişiye geri dönüş yapılması iki farklı event'tir. Talep sahibi burada değil, support_request_received üzerine REM-305 tarafından bilgilendirilir" },
    ...
    "x.attached": { headline: "mevcut vakaya eklendi", detail: "sonucu vakanın kendi lifecycle'ı belirler; geri bildirim kaydı kanıt olarak kalır" },
  ...
  nodes: {
    ...
    "h.escalate": { headline: "external:human-in-the-loop-lifecycle", detail: "yükseltme basamaklarını aşan bir sorun" },
  ...
  nodes: {
    ...
    "c.event": { headline: "Yükümlülüğe ne oldu?", edges: [{ label: "Bir finansal işlem bunun bir kısmını veya tamamını kapattı", detail: "bir ödeme, alacak veya mutabakat uygulandı" }, { label: "Düzeltildi veya iptal edildi", detail: "tutar, koşullar veya yükümlülüğün varlığı yetkili bir şekilde değişti" }, { label: "Vade durumu değişti", detail: "vadesi geldi veya karşılanmadan vade tarihini geçti" }] },
    ...
    "x.adjusted": { headline: "yükümlülük düzeltildi; önceki sürümler korunuyor", detail: "düzeltilen yükümlülük kendi lifecycle'ında yeni tutarıyla devam eder" },
  },
  },
  "FIN-134": {
  ...
  nodes: {
    ...
    "w.final": { headline: "yükümlülük ana sistemde karşılanana veya sahibi geri dönüş yolunu takip etmeyi bırakana kadar", detail: "zaman aşımı: Kurtarma penceresi, yükümlülük sınıfının kendi ek süre veya sonuç politikasıdır. Sürenin sona ermesi ödeme, gecikme veya kısıtlama lifecycle'ının sonucudur; burada yeni bir uzatma üretilmez. (yapılandırma: payment.recovery_window)" },
  },
  },
  "FIN-136": {
  ...
  nodes: {
    ...
    "c.event": { headline: "Tahsise ne oldu?", edges: [{ label: "Tüketildi", detail: "ifa onu kullandı" }, { label: "Artık gerekli değil", detail: "ifa iptal edildi ya da kapsamı değişti ve bu kaynağa artık ihtiyaç yok" }, { label: "Kaynağın kendisi kullanılamaz hale geldi", detail: "rezerve edilen şey hasar gördü, geri çekildi ya da başka bir şekilde ortadan kalktı" }] },
  ...
  "IDN-271": {
  shortName: "Hesap Güvenlik Uyarısı",
  name: "Ele geçirme sinyali → kapsamlı sınırlama → sahip doğrulaması → kurtar veya temizle",
  purpose: "Şüpheli bir ele geçirmeyi çözecek tek soruyu, şüphenin dokunmadığı bir yoldan sahibine sormak; bu arada gerçekte bir şeyin kısıtlanıp kısıtlanmadığını açıkça belirtmek.",
  nodes: {
    "t.signal": { headline: "Kapsamı belirlenmiş ele geçirme olayı açıldı" },
    "c.route": { headline: "Sinyalin işaret etmediği bir hedef var mı?", edges: [{ label: "Temiz yol", detail: "bir iletişim noktası etkilenen kapsamın dışında ve şüpheli pencere içinde eklenmemiş veya değiştirilmemiş" }, { label: "Her yol şüpheli", detail: "tek hedefler şüpheli pencerede değiştirildi ya da sorgulanan erişimin arkasında bulunuyor" }] },
    "c.contained": { headline: "Gerçekte bir şey kısıtlandı mı?", edges: [{ label: "Sınırlama uygulandı", detail: "oturumlar, kimlik bilgileri veya yetkinlikler kısıtlandı; önce biz söylesek de söylemesek de sahibi bu kısıtlamayla karşılaşacak" }, { label: "Hiçbir şey kısıtlanmadı", detail: "kanıt kısıtlamayı haklı çıkarmadı ve hesap normal şekilde çalışıyor" }] },
    "x.withheld": { headline: "şüphenin dışında hedef yok; uyarı gönderilmedi", detail: "etkilenen kapsamın dışında bir hedef belirlenirse doğrulama sorusu oradan işletilir" },
    "a.alert-contained": { headline: "Neyin, neden kısıtlandığını ve son etkinliğin kendilerine ait olup olmadığını doğrulamanın konuyu çözeceğini belirt. Habersizce karşılaşılan bir kısıtlama, sınırlamak için var olduğu ele geçirmeden ayırt edilemez" },
    ...
    "x.cleared": { headline: "temizlendi; kısıtlamalar kaldırıldı ve sahibine bildirildi", detail: "aynı hesapta gelecek başka bir sinyal, yeni bir olay ve yeni bir örnektir" },
  },
  },
  "IDN-81": {
  ...
  nodes: {
    ...
    "x.reconciled": { headline: "kimlik güncellendi; her bağımlı kendi koşullarına göre yeniden değerlendirildi", detail: "sonraki adımı her bağımlının kendi journey'si belirler; ulaşılabilirlik, izin ve kimlik bilgisi lifecycle'ları farklı sahip ve kurallarla ayrı ayrı tetiklenir" },
  },
  },
  "IDN-90": {
  ...
  nodes: {
    "t.invited": { headline: "İlişki daveti gönderildi" },
    "c.known": { headline: "Karşı taraf burada zaten kendi adına bir kayda sahip mi?", edges: [{ label: "Mevcut kayıt sahibi", detail: "karşı taraf zaten kendi kaydına ve oturumuna sahip; davet buna eklenecek" }, { label: "Bizim için yeni", detail: "karşı tarafın burada bir kaydı yok ve daveti gönderen tarafı tanıyor ama bizi tanımıyor" }] },
    "a.invite-known": { headline: "Kendilerini kimin davet ettiğini, bu bağlantının o tarafa tam olarak neyi yapma imkânı vereceğini ve kendi kayıtları hakkında neyi değiştirmeyeceğini belirt. Mevcut bir kayıt sahibinin ilk sorusu, kabul etmenin daveti gönderene ne kazandıracağı değil, kendisine ne kaybettireceğidir" },
    ...
    "x.expired": { headline: "yanıtsız olarak süresi doldu", detail: "aynı taraftan gelecek yeni bir davet, yeni bir süre başlatır" },
    "x.active": { headline: "bağlantı etkin, her iki kimlik de bozulmadan kaldı", detail: "aynı taraflar arasında farklı bir kapsam için gönderilecek yeni bir davet, ayrı bir örnektir" },
    "w.final": { headline: "karşı taraf daveti kabul edene, karşı taraf daveti reddedene ya da daveti gönderen taraf daveti geri çekene kadar", detail: "zaman aşımı: Tek hatırlatmanın ardından örnek, davetin kendi süresinin dolmasını bekler; ikinci bir hatırlatma yoktur. (yapılandırma: relationship_invitation.final)" },
  },
  },
  "REL-91": {
  ...
  nodes: {
    ...
    "a.activate": { headline: "Türü, yönü, kapsamı ve yürürlük zamanıyla birlikte ACTIVE_RELATIONSHIP kaydını oluştur. Bir ilişki kurmak iki varlığı birbirine bağlar, hiçbir şeyi birleştirmez - her iki varlık da kendi kimliğini, kendi lifecycle'ını ve kendi geçmişini korur" },
  ...
  name: "Etkileşim durumu değişikliği → yeniden sınıflandırma → uygun lifecycle",
  ...
  nodes: {
    ...
    "h.adoption": { headline: "Benimseme durgunluğu → eksik değeri teşhis et → kurtar ya da yeniden yönlendir", detail: "benimsemenin azalmasının yol açtığı kötüleşme" },
    ...
    "h.technical": { headline: "external:human-in-the-loop-lifecycle", detail: "çözülmemiş bir teknik sorun ya da tekrarlayan destek sürtünmesi" },
  ...
  "RET-26": {
  shortName: "Hizmet Kurtarma",
  name: "Olumsuz deneyim → kurtarma uygunluğu → uygun yanıt",
  purpose: "Yanıtı, gerçekte neyin başarısız olduğuyla, düzeltilip düzeltilmediğiyle ve gerçekten bir tazminatın gerekip gerekmediğiyle eşleştirin.",
  nodes: {
    "t.negative": { headline: "Doğrulanmış olumsuz deneyim" },
    "a.assess": { headline: "Neyin başarısız olduğunu, müşteriye maliyetinin ne olduğunu, çözülüp çözülmediğini, hâlâ etkilenip etkilenmediklerini ve başka bir sürecin bunu zaten ele alıp almadığını belirleyin" },
    "c.duplicate": { headline: "Bu hatayı zaten ele alan başka bir kurtarma süreci var mı?", edges: [{ label: "Zaten ele alınıyor", detail: "açık bir vaka, atanmış bir sahip ya da başka bir kurtarma süreci aynı olayı kapsıyor" }, { label: "Kimse ilgilenmiyor", detail: "mevcut hiçbir süreç bunu kapsamıyor" }] },
    "x.defer": { headline: "zaten ele alan sürece bırakıldı", detail: "o süreç, müşteri hâlâ etkilenmiş durumdayken kapanırsa bu yeniden açılır - iki sistemden gelen iki özür, birinden gelen bir özürden daha kötüdür, çünkü ikisinin de birbirinden haberdar olmadığını kanıtlar" },
    "c.resolved": { headline: "Altta yatan sorun hâlâ çözülmemiş mi?", edges: [{ label: "Hâlâ bozuk", detail: "müşteri etkilenmeye devam ediyor" }, { label: "Çözüldü", detail: "hata sona erdi ve müşteri artık etkilenmiyor" }] },
    "h.operational": { headline: "external:operational-resolution", detail: "hâlâ devam eden bir hata" },
    "c.useful": { headline: "Burada bir kurtarma iletişimi gerçekten yararlı mı?", edges: [{ label: "Yararlı", detail: "müşteri fark etti ya da ele alındığını bilmek isterdi" }, { label: "Yararlı değil", detail: "hata onlara ulaşmadan önce çözüldü - şimdi bunu gündeme getirmek, özür dilenecek endişeyi kendisi yaratır" }] },
    "c.compensation": { headline: "Politika ve gerçek etki, tazminatı destekliyor mu?", edges: [{ label: "Hak ediliyor", detail: "hem etki hem de politika bir tazminatı destekliyor" }, { label: "Hak edilmiyor", detail: "hata gerçekti ama bir tazminatı haklı çıkarmıyor - hataların çoğu böyledir" }] },
    "x.silent": { headline: "iletişime geçilmeden çözüldü", detail: "bir tekrar ya da fark ettiklerine dair herhangi bir işaret bunu yeniden açar" },
    "h.compensation": { headline: "Tazminat kararı → uygunluk → onayla ya da reddet → teslim et", detail: "hem politikanın hem de etkinin desteklediği bir tazminat" },
    "a.acknowledge": { headline: "Neyin başarısız olduğunu, bunun için ne yapıldığını ve tekrar yaşanmasını neyin önlediğini söyleyin. Hiçbir indirim bir açıklamanın yerini tutmaz - neyin yanlış gittiğinin bir açıklaması yerine sunulan bir tazminat, sessizlik satın almak gibi okunur" },
    "x.acknowledged": { headline: "hata kabul edildi, tazminat hak edilmiyor", detail: "bir tekrar değerlendirmeyi değiştirir ve tekrarın kendisi de etkinin bir parçasıdır" },
  },
  },
  "RET-27": {
  ...
  nodes: {
    ...
    "h.normal": { headline: "external:customer-lifecycle", detail: "istikrar penceresi boyunca sürdürülen kurtarma" },
  },
  },
  "RET-28": {
  ...
  nodes: {
    ...
    "a.termination-state": { headline: "Bunun gerçekte ne zaman sona erdiğini belirleyin: hemen, mevcut dönemin sonunda ya da planlanmış gelecek bir tarihte. Sonrasındaki her şey buna bağlıdır ve bunu hemen olarak varsaymak, ücretli hakların erken iptal edilmesine yol açar" },
  ...
  "RET-30": {
  shortName: "Elde Tutma Teklifi Takibi",
  name: "Elde tutma müdahalesi → sonuç → durdur, yükselt ya da çık",
  purpose: "Bir elde tutma girişimini, ilişkiye gerçekte ne olduğuna göre sonuçlandırın ve aynı teklifin iki kez yapılmasını önleyin.",
  nodes: {
    "t.delivered": { headline: "Elde tutma müdahalesi teslim edildi" },
    "w.outcome": { headline: "kişi sunulan elde tutma alternatifini kabul edene, kişi elde tutma alternatifini açıkça reddedene, ilişkinin kendi durumu kişi teklife yanıt vermeden düzelene, müdahale uygulanamadığı belli olana, iptal onaylanana ya da kişi iptal akışından çıkana kadar", detail: "zaman aşımı: Sınırlı bir karar penceresinin ardından. (yapılandırma: retention_intervention.outcome)" },
    "c.outcome": { headline: "Müdahaleye ne oldu?", edges: [{ label: "Kabul edildi", detail: "müşteri sunulanı kabul etti" }, { label: "Reddedildi", detail: "müşteri bunu açıkça reddetti" }, { label: "Yanıt vermeden düzeldi", detail: "ilişki iyileşti ama teklifin kendisine kimse yanıt vermedi" }, { label: "Uygulanamadı", detail: "müdahale kabul edildi ya da denendi ama gerçekte uygulanmadı" }, { label: "Bu arada karar verildi", detail: "iptal onaylandı ya da kişi iptal akışından çıktı; teklifin kendisi yanıtlanmadı - her iki durumda da karar verilmiştir ve bu journey onu yeniden açmaz" }] },
    "c.followup": { headline: "Yanıt yokken, sınırlı bir takip haklı mı?", edges: [{ label: "Haklı", detail: "teklif süreyle sınırlı ya da koşulları muhtemelen anlaşılmamış" }, { label: "Haklı değil", detail: "sessizlik yeterince açık bir yanıttır ve bunu tekrarlamak yalnızca baskı ekler" }] },
    "a.verify": { headline: "Kayıt sistemine karşı ilişkinin gerçekten değiştiğini doğrulayın - plan değişti, durdurma etkin, konu kapandı, abonelik korundu. Kabul, müşterinin evet demesidir; uygulanma ise durumun gerçekten değişmiş olmasıdır ve ikisi arasındaki fark, elde tutma rakamlarının yanlış çıktığı yerdir" },
    "a.record-decline": { headline: "Reddi bu iptal bölümüne karşı kaydedin, böylece aynı teklif bu bölüm içinde tekrar yapılmaz. Reddedilen bir teklifi tekrarlamak, bir kurtarma girişiminin bir engel gibi okunmasına yol açan davranıştır" },
    "h.observe": { headline: "Kurtarma sinyali → gözlem tamponu → istikrarlı ya da tekrar kötüleşme", detail: "olumlu görünen bir elde tutma sonucu" },
    "h.fix": { headline: "external:operational-resolution", detail: "uygulanmayan bir müdahale" },
    "a.followup": { headline: "Bir takip gönderin ve durun. İlişkinin değeri ne olursa olsun ikinci bir takip yoktur" },
    "x.cooldown": { headline: "yanıt yok; bölüm kapandı, bekleme süresi yürürlükte", detail: "yeni kanıtlarla yeni bir bölüm açılabilir ve bu müdahale bekleme süresi içinde tekrarlanmaz" },
    "c.applied": { headline: "Durum gerçekten değişti mi?", edges: [{ label: "Uygulandı", detail: "doğrulanmış kayıt değişikliği gösteriyor" }, { label: "Kabul edildi ama uygulanmadı", detail: "müşteri kabul etti ama değişiklik yürürlüğe girmedi" }] },
    "c.proceed": { headline: "Bir iptal hâlâ devam ediyor mu?", edges: [{ label: "Hâlâ iptal ediyor", detail: "müşteri reddetti ve ayrılmaya devam ediyor" }, { label: "Devam eden bir iptal yok", detail: "teklif reddedildi ama hiçbir şey iptal edilmiyor" }] },
    "h.proceed": { headline: "İptal talebi → geçerlilik bitişini belirle → zamanla ya da şimdi iptal et", detail: "iptali devam eden, reddedilmiş bir kurtarma teklifi" },
    "x.declined": { headline: "müdahale reddedildi, ilişki bozulmadan kaldı", detail: "yeni kanıtlarla yeni bir bölüm farklı bir müdahaleyi haklı çıkarabilir; reddedilen teklif bu bölüm içinde tekrar gönderilmez" },
  },
  },
  "RET-31": {
  ...
  nodes: {
    ...
    "w.response": { headline: "kaybedilen ilişki tekrar ödeme yapana ya da kişi için herhangi bir konuda doğrulanmış bir satın alma gerçekleşene kadar", detail: "zaman aşımı: Davetin, kişinin kendi zamanında değerlendirilmesi için süre tanınır; bu süre içindeki bir takip, zaten bir kez ayrılmış birinin üzerinde baskı oluşturur. (örnek: 14 gün–30 gün; yapılandırma: winback.response_window)" },
    ...
    "c.second": { headline: "Bir takip etkin mi ve eklenecek dürüst bir şey var mı?", edges: [{ label: "Etkin ve eklenecek bir şey var", detail: "şirket takibi etkinleştirdi (winback.follow_up_enabled) ve ya bir teşvik politikası son iletişim için bir teklife izin veriyor ya da ek bir değişiklik kaydedildi" }, { label: "Etkin değil ya da eklenecek bir şey yok", detail: "takip devre dışı ya da zaten gönderilmiş davetin ötesinde dürüstçe söylenecek bir şey yok" }] },
    "c.sendable2": { headline: "Takip gönderilebilir mi?", edges: [{ label: "Gönderilebilir", detail: "gönderim yolu geçiyor ve iletişim bütçesi harcanmadı" }, { label: "Engellendi", detail: "bir engel bunu durduruyor; engel kaydediliyor" }] },
    "x.lapsed": { headline: "davet edildi, geri dönmedi; bekleme süresi boyunca kendi haline bırakıldı", detail: "bekleme süresi geçene kadar başka bir geri kazanma örneği açılmaz" },
    "a.touch2": { headline: "Neyin eklendiğini bir kez söyleyin - etkinleştirilen teşvik ya da ek değişiklik - aynı geri dönüş yoluyla birlikte, ve bir teşvik verildiyse bunun kişi başına verilişini kaydedin" },
    "w.final": { headline: "kaybedilen ilişki tekrar ödeme yapana ya da kişi için herhangi bir konuda doğrulanmış bir satın alma gerçekleşene kadar", detail: "zaman aşımı: Takipten sonra örnek yalnızca bir geri dönüşü gözlemlemek için açık kalır; ardından sona erer ve uzun bekleme süresi başlar. (örnek: 30 gün–60 gün; yapılandırma: winback.lifetime)" },
  },
  },
  "RLT-279": {
  ...
  nodes: {
    ...
    "x.consumed": { headline: "onaylanan bir rezervasyona dönüştürüldü; kapasite bir daha hiç boşa geçmedi", detail: "kapasiteye artık rezervasyon sahiptir. Bir iptal, bu tutma üzerinden değil, iptal lifecycle'ı üzerinden kapasiteyi serbest bırakır" },
  ...
  nodes: {
    ...
    "a.initiate": { headline: "Her eksik ön koşulu kendi lifecycle'ında başlat. Bunlar çalışırken rezervasyonun zamanı değişmez ve hiçbiri rezervasyonun sahibi değildir" },
    ...
    "c.event": { headline: "Bekleyişi ne sonuçlandırdı?", edges: [{ label: "Hazırlık tamamlandı", detail: "kontrol noktasından önce her ön koşul tamamlandı" }, { label: "Rezervasyon değişti", detail: "rezervasyon ertelendi, iptal edildi veya esaslı biçimde değiştirildi" }] },
    ...
    "a.at-risk": { headline: "Eksik ön koşulu belirterek politikaya göre RİSK_ALTINDA veya BEKLETİLDİ olarak kaydet. Onaylanmış zamanı değiştirme; randevuyu ötelemek erteleme lifecycle'ına ait ayrı bir rezervasyon kararıdır" },
  ...
  "SCH-280": {
  shortName: "Gelmeme Sonrası Takip",
  name: "Gelmeme onaylandı → kaçırılan durumu doğrulama → yeniden rezervasyon veya kapatma",
  purpose: "Rezervasyonu gerçekleşmeyen birine geri dönüş yolu sunmak, ama önce kaçırmanın kendisinden değil bizden kaynaklanmadığını tespit ederek - çünkü kendi hatamız yüzünden gönderilen bir yeniden rezervasyon uyarısı bir suçlamadır.",
  nodes: {
    "t.no-show": { headline: "Rezervasyona karşı gelmeme kaydedildi" },
    "a.reread": { headline: "Hiçbir şey gönderilmeden önce rezervasyonun en güncel olaylarını yeniden oku. Katılım ve iptal olayları geç ulaşabilir, ve kaydın yazılmasıyla mesajın gönderilmesi arasındaki boşluk, doğru bir iptalin bir kaçırma olarak ele alınmasına yol açan tam olarak o andır" },
    "c.superseded": { headline: "Rezervasyon gerçekten gerçekleşmedi mi?", edges: [{ label: "Geçersiz kılındı veya uzlaştırıldı", detail: "gelmeme kaydedildikten sonra bir iptal, bir erteleme veya geç gelen bir katılım olayı ulaştı" }, { label: "Gerçekten kaçırıldı", detail: "kayıt, yeniden okumadan sonra da geçerliliğini koruyor" }] },
    "x.suppressed": { headline: "hiçbir şey gönderilmedi; rezervasyon taşındı, iptal edildi veya sonuçta gerçekleşti", detail: "sonradan gerçekten kaçırılan bir rezervasyon kendi örneğidir" },
    "c.provider": { headline: "Sağlayıcı veya kaynak gerçekten hizmeti verebilir miydi?", edges: [{ label: "Verebilirdi", detail: "sağlayıcı ve kaynak, pencerenin tamamı boyunca müsait ve yeterliydi" }, { label: "Bizim tarafımız başarısız oldu", detail: "sağlayıcı, kaynak veya konum, onaylandığı şekilde hizmeti veremezdi" }] },
    "c.rebookable": { headline: "Sunulacak bir şey var mı?", edges: [{ label: "Yeniden rezervasyon mevcut", detail: "aynı taahhüt hâlâ karşılanabilir ve bunun için kapasite var" }, { label: "Yeniden rezerve edilecek bir şey yok", detail: "taahhüdün süresi doldu, arkasındaki hak kalktı, veya hiçbir kapasite kalmadı" }] },
    "h.provider": { headline: "Sağlayıcı veya kaynak iptali → yeniden tahsis → erteleme, düzeltme veya iptal", detail: "sağlayıcının veya kaynağın veremeyeceği, kaçırılmış bir rezervasyon" },
    "a.offer": { headline: "Rezervasyonun ceza dili kullanılmadan kaçırıldığını bir olgu olarak söyle, ve yeni bir rezervasyona giden tek yolu, bu yolun ne zaman kapanacağını belirterek ver. Kaçırmaya suç yüklemek, yeniden rezervasyonu bir itirafa dönüştürür, ve insanlar itiraf etmek için rezervasyon yapmaz" },
    "a.acknowledge": { headline: "Rezervasyonun gerçekleşmediğini ve bunun ne anlama geldiğini açıkça belirt, hiçbir yeniden rezervasyon uyarısı eklemeden - çünkü rezerve edilecek bir şey yok. Arkasında hiçbir şey olmayan bir teklif, hiçbir şey söylememekten daha fazla güven kaybettirir" },
    "w.rebook": { headline: "Aynı taahhüt için yeni bir rezervasyon oluşturulana, veya müşteri başka bir rezervasyonu reddedene kadar bekle", detail: "zaman aşımı: Teklif, içinde belirtilen pencere boyunca geçerlidir; pencere geçtiğinde örnek kapanır ve teklif tekrar sunulmaz. (örnek: 7 gün–14 gün; yapılandırma: no_show.rebooking_window)" },
    "x.closed": { headline: "yeniden rezervasyon olmadan kapatıldı", detail: "müşteriden sonradan gelen bir talep, bu değil, olağan yol üzerinden rezervasyonu yeniden açar" },
    "c.outcome": { headline: "Teklif nasıl sonuçlandı?", edges: [{ label: "Yeniden rezerve edildi", detail: "aynı taahhüde karşı yeni bir rezervasyon var" }, { label: "Reddedildi", detail: "müşteri başka bir rezervasyon istemediğini söyledi" }] },
    "x.rebooked": { headline: "yeniden rezerve edildi", detail: "yeni rezervasyonun kendi lifecycle'ı var ve sonraki bir kaçırma yine buraya girer" },
  },
  },
  "SCH-282": {
  ...
  nodes: {
    ...
    "a.recovery": { headline: "Başarısızlığı, sınıflandırma ve tahsilatın sahibi olan ödeme tahsilatı lifecycle'ına handoff et. Bu journey parayı takip etmez; tahsilat sürerken ilişkinin durumunu tutar" },
    ...
    "a.restrict": { headline: "Kısıtlamayı, politikanın tanımladığı kapsamla birlikte erişim lifecycle'ına handoff et. Neyin nasıl kapatılacağının sahipliği orada, ilişkinin sözleşmesel durumunun sahipliği burada kalır" },
  ...
  nodes: {
    ...
    "a.restrict": { headline: "SUSPENDED olarak kaydet ve gerekli erişim kısıtlamasını, uygulamanın sahibi olan erişim lifecycle'ına handoff et. Bu journey ilişkinin sözleşmesel durumunu tutar; askıya alınmış olmak iptal edilmiş olmak değildir" },
    ...
    "a.restore": { headline: "Yeniden ACTIVE olarak kaydet ve erişimi, eski haklara değil ilişkinin güncel koşullarına göre geri yüklemek üzere erişim lifecycle'ına handoff et" },
  ...
  purpose: "İlişkinin tanıdığı hakları durdururken, yarattığı her şeyin kendi lifecycle'ını sürdürmesine izin vermek.",
  nodes: {
    ...
    "a.entitlement-loss": { headline: "Hak geri alımını burada uygulamak yerine hak tanıma lifecycle'ına handoff et. Hangi hakların sonlandırmadan sonra süreceği, hakkın kendi kuralıdır; burada ayrıca karar verilirse iki lifecycle çelişebilir" },
    "a.wind-down": { headline: "Her bağımlı alanın ihtiyaç duyduğu tasfiye sürecini ilet - hizmetten çıkarma, nihai faturalandırma, varsa borçlu olunan iade veya kredi, açık teslimatlar ve geçerliyse veri saklama. Her biri kendi lifecycle'ında işler ve kendi sonucuna ulaşır; hiçbiri burada uygulanmaz" },
    ...
    "a.preserve": { headline: "Bu yükümlülükleri koru ve kendi lifecycle'larında sonuçlanmalarına izin ver. Abonelik aktifken oluşan sipariş, iade veya anlaşmazlık sonlandırmayla ortadan kalkmaz; sonlandırma yalnızca gelecekteki hakları durdurur" },
    ...
    "a.terminal": { headline: "İlişkinin kendi anlamının tanımladığı nihai durumu kaydet - FORMER, EXPIRED veya TERMINATED. Bu, ilişkinin sona ermesidir. Hesabın kapanması ya da verinin silinmesi değildir; bunların ikisi de kendi yetkisi ve kendi lifecycle'ı olan ayrı kararlardır ve hiçbiri bundan otomatik olarak doğmaz" },
    ...
    "x.former": { headline: "FORMER, EXPIRED veya TERMINATED; hesap, geçmiş ve devam eden yükümlülükler korunur", detail: "yeni abonelik, sözleşme veya üyelik yeni bir ilişkidir. Geçmiş okunabilir kalır; açık yükümlülükler kendi lifecycle'ı sonuçlandırana kadar devam eder" },
  ...
  nodes: {
    ...
    "x.lost": { headline: "pencere kurtarılmadan kapandı", detail: "daha sonra verilen bir geçerlilik yeni bir lifecycle başlatır; buraya yeniden girmek için yeni bir düşüş gerekir" },
  },
  },
  "TIM-281": {
  shortName: "Süresi Dolmuş Erişimin Kurtarılması",
  name: "Süresi dolmuş hak dokunuldu → yeniden giriş yolu → yeniden hak kazan, değiştir veya süresi dolmuş kalsın",
  purpose: "Süresi dolmuş bir şeye geri dönen birine, tam sorduğu anda, bunu gerçekten geri yükleyecek tek yolu göster - çünkü yanlış yolu belirtmek, bunun elde edeceği tek niyeti harcamaktır.",
  nodes: {
    "t.touched": { headline: "Sahip, süresi dolmuş varlık üzerinde işlem yaptı" },
    "a.establish": { headline: "Herhangi bir geri dönüş yolu belirtmeden önce, süre dolumunun bu varlığa gerçekte ne yaptığını belirle - askıya mı aldı, geçersiz mi kıldı, yoksa arkasındaki ilişkiyi mi sonlandırdı. Her düşüşü aynı düşüş gibi okumak, yalnızca değiştirilebilecek bir şeyi yenilemeye yönlendirmenin yoludur" },
    "c.route": { headline: "Burada geçerliliği hangi mekanizma geri yüklüyor?", edges: [{ label: "Yenileme", detail: "yönetici kurallar, aynı varlığın kaldığı yerden devam etmesine izin veriyor" }, { label: "Yeniden Hak Kazanma", detail: "geçerlilik, yeniden karşılanması gereken bir kanıta veya kontrole bağlı" }, { label: "Yalnızca Değiştirme", detail: "süresi dolmuş varlık tekrar geçerli hale gelemez; yerine yenisinin verilmesi gerekir" }, { label: "Geri Dönüş Yolu Yok", detail: "geçerliliği geri getirecek hiçbir şey yok - buna dayanak oluşturan şey ortadan kalkmış" }] },
    "a.renew": { headline: "Yolu yenileme olarak belirt, maliyetini ve boşluk boyunca neyin devam ettiğini söyle. Kendi isteğiyle geri dönen birinin ikna edilmeye değil, sonrasında tam olarak ne yapması gerektiğinin söylenmesine ihtiyacı vardır" },
    "a.requalify": { headline: "Bunun bir yenileme olmadığını ve koşulların yeniden karşılanması gerektiğini açıkça söyle, koşulları da sırala. Birine tek bir tıklamanın sorunu çözeceğini düşündürüp yarı yolda kanıt istemek, istekli gelen bir niyetin sinirlenerek ayrılmasına yol açar" },
    "a.replace": { headline: "Eskisinin süresi dolmuş olarak kalacağını, yerine yenisinin verileceğini ve ikisi arasındaki farkı açıkla. Yenisi farklı bir nesnedir; sahibine daha sonra hiçbirine sahip olmadığı bir dönem hakkında sorular sorulacaktır" },
    "a.no-route": { headline: "Buna geri dönüşün mümkün olmadığını söyle ve varsa yerine ne olduğunu belirt. Açıkça belirtilen bir çıkmaz sokak, girişimi bir kerede bitirir; belirsiz bırakılan bir çıkmaz sokak ise üç girişim daha ve bir destek talebi doğurur" },
    "w.act": { headline: "belirtilen geri dönüş yolu tamamlanıp geçerlilik geri yüklenene, ya da sahip bu yolu izlemeyi bırakana kadar", detail: "zaman aşımı: Belirtilen yol, belirtildiği andan itibaren sınırlı bir yanıt penceresi boyunca açık kalır; kullanılmayan bir yol, hâlâ süresi dolmuş olarak kapanır. (expired_entity.act yapılandırın)" },
    "x.terminal": { headline: "geri dönüş yolu olmadan süresi doldu", detail: "buraya yeniden giriş yoktur - bu türden yeni bir hak farklı bir nesnedir ve kendi verildiği andan itibaren başlar" },
    "c.outcome": { headline: "Geçerlilik geri geldi mi?", edges: [{ label: "Yeniden geçerli", detail: "yol tamamlandı ve sahip için artık geçerli bir şey var" }, { label: "Vazgeçildi", detail: "sahip yarı yolda durdu veya yolu açıkça reddetti" }] },
    "x.still-expired": { headline: "hâlâ süresi dolmuş durumda; yol sunuldu ama kullanılmadı", detail: "sahibin sonraki bir girişimi, yolun güncel kurallara göre yeniden değerlendirildiği yeni bir örnek başlatır" },
    "a.confirm": { headline: "Şu anda neyin geçerli olduğunu, bir değiştirme yapıldıysa bunun eskisinin canlandırılması değil yeni bir şey olduğunu onayla. Hiçbir şeyin geçerli olmadığı boşluk dönemi, sahibin daha sonra ihtiyaç duyacağı bir gerçektir; bunu burada gizlemek, o konuşmanın kötü gitmesine yol açar" },
    "x.restored": { headline: "belirtilen yol sayesinde yeniden geçerli", detail: "geri yüklenen veya yerine geçen varlığın kendi süre dolumu vardır; sonraki bir düşüş yeniden buraya girer" },
  },
  },
  "TIM-61": {
  ...
  nodes: {
    ...
    "h.resolved": { headline: "external:renewal-lifecycle", detail: "süresi dolmadan önce çözülen bir varlık" },
  },
  },
  "TIM-65": {
  ...
  nodes: {
    ...
    "h.terminate": { headline: "external:termination-lifecycle", detail: "erişimin veya ilişkinin sona ermesiyle biten ek süre" },
  ...
  nodes: {
    ...
    "a.confirm-closure": { headline: "Hesap ilişkisinin kapandığını doğrula ve bunun abonelik iptali ya da veri silme olmadığını açıkça belirt. Her ikisinin de ayrı lifecycle'ı ve kanıtı vardır. Bildirimi talep anında değil, kapatma doğrulandıktan sonra gönder" },
  ...
  nodes: {
    ...
    "c.sendable": {
      ...
      edges: [
        { label: "Gönderilebilir", detail: "gönderim kontrolleri geçiliyor: bu amaç için izin var, ulaşılabilir bir kanal var, hizmet contact pressure limiti aşılmadı, aktif bir bekleme süresi yok ve kişiyi daha yüksek öncelikli bir ulaşılabilirlik journey'si tutmuyor" },
...
const EXTERNAL_TARGET_TR: Readonly<Record<string, string>> = {
  ...
  "external:customer-lifecycle": "Müşteri lifecycle'ı",
  ...
  "external:renewal-lifecycle": "Yenileme lifecycle'ı",
