...
const OVERRIDES: Readonly<Record<string, JourneyOverride>> = {
  ...
  nodes: {
    ...
    "x.advocacy-eligible": { headline: "savunuculuk için uygun; birikmiş ilişki kanıtı eşiğe ulaştı, talep yapılmadı", detail: "yeni olumlu geri bildirim kendi kaydını açar ve kanıtı yeniden tartar" },
