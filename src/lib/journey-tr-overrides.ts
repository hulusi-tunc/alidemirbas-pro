...
const OVERRIDES: Readonly<Record<string, JourneyOverride>> = {
  ...
  nodes: {
    ...
    "h.assistance": { headline: "external:human-in-the-loop-yaşam döngüsü", detail: "bir kişi gerektiren teknik bir engel" },
  ...
  nodes: {
    ...
    "x.received": { headline: "geri bildirim alındı; ne anlama geldiğini FBK-43 belirler", detail: "bu sürecin görevi talep aşamasında sona erdi; gelen yanıtın kendi yaşam döngüsünü var" },
  ...
  nodes: {
    ...
    "x.rebooked": { headline: "yeniden rezerve edildi", detail: "yeni rezervasyonun kendi yaşam döngüsünü var ve sonraki bir kaçırma yine buraya girer" },
  },
  },
  "SCH-282": {
