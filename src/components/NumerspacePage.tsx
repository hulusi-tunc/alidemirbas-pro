...
const T = {
  en: {
    ...
    heroSub: "Free calculators for everyday questions: money, health, work, time, marketing. No account required.",
    ...
    verifyNote: "The formula and every input are shown in the computation trace.",

    whyEyebrow: "Manifesto",
    whyLabel: "Product ethos",
    whyTitle: "A calculator should answer the question, then get out of the way.",
    whyBody: "Numerspace is a bilingual collection of practical calculators. Open a tool, enter what you know, read the result. No account, no modal overlays, and your inputs are not sent to a server.",
    whyBody2: "Most online calculators exist to collect telemetry or push a newsletter signup. Numerspace is meant to behave like a good instrument: plain typography, a deterministic result the moment you type, nothing competing for your attention.",
    ...
    catSub: "Finance, health, work, travel and everyday arithmetic. Grouped by category, one click to any tool.",
    ...
    privacySub: "Most calculations run in your browser. Inputs are not sent to Numerspace, and there is no account to store them in.",
    ...
    ctaTitle: "Pick a calculator and start typing.",
    ctaAbout: "About the creator",
  },
  tr: {
    eyebrow: "Lab / Araç 01",
    heroTitle: "97 hesaplayıcı. Üyelik yok. Veri saklanmıyor.",
    heroSub: "Günlük sorular için ücretsiz hesaplayıcılar: para, sağlık, iş, zaman, pazarlama. Hesap açmak gerekmez.",
    ...
    verifyNote: "Formül ve her girdi hesaplama izinde görünür.",

    whyEyebrow: "Manifesto",
    whyLabel: "Ürün felsefesi",
    whyTitle: "Bir hesaplayıcı soruyu yanıtlamalı, sonra yoldan çekilmeli.",
    whyBody: "Numerspace, pratik hesaplayıcılardan oluşan iki dilli bir koleksiyon. Bir aracı aç, bildiklerini gir, sonucu oku. Hesap yok, modal pencere yok; girdiğin sayılar sunucuya gitmiyor.",
    whyBody2: "Çoğu çevrimiçi hesaplayıcı telemetri toplamak ya da bülten aboneliği almak için var. Numerspace iyi bir alet gibi davranmayı hedefliyor: sade tipografi, yazdığın anda çıkan deterministik sonuç, dikkatini çelen hiçbir şey yok.",
    ...
    catSub: "Finans, sağlık, iş, seyahat ve gündelik hesaplar. Kategorilere ayrılmış; her araç bir tık uzakta.",
    catCount: (n: number) => `${n} hesaplayıcı`,
    catExploreAll: "13 kategorinin tamamını gör",

    privacyEyebrow: "Tasarım gereği gizlilik",
    privacyTitle: "Sayıların tarayıcında kalır.",
    privacySub: "Hesaplamaların çoğu tarayıcınızda çalışır. Girdiler Numerspace'e gönderilmez; saklanacakları bir hesap da yok.",
    step1Label: "01 · İstemci",
    step1Title: "Kullanıcı girdisi",
    step1Sub: "Sayfa içinde kalır",
    step2Label: "02 · Yerel motor",
    step2Title: "Tarayıcın",
    ...
    relatedEyebrow: "Lab'da ayrıca",
    relatedCta: "Aç",

    ctaEyebrow: "Araca git",
    ctaTitle: "Bir hesaplayıcı seç, yazmaya başla.",
