...
/* Inline Cal.com booking calendar. calLink is the public slug from
   ...
   matches this site's --color-primary-600 (#e05d38, terracotta as of the
   2026-09-04 rebrand) so the calendar reads as part of the page rather
   than a foreign iframe. */
export function CalEmbed() {
  useEffect(() => {
    (async function run() {
      ...
      cal("ui", {
        theme: "light",
        styles: { branding: { brandColor: "#e05d38" } },
