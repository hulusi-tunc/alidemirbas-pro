...
/* Inline Cal.com booking calendar. calLink is the public slug from
   ...
   matches this site's --color-primary-600 (#2f6bff, the brand guideline's
   blue as of the 2026-09-04 rebrand) so the calendar reads as part of the
   page rather than a foreign iframe. */
export function CalEmbed() {
  useEffect(() => {
    (async function run() {
      ...
      cal("ui", {
        theme: "light",
        styles: { branding: { brandColor: "#2f6bff" } },
