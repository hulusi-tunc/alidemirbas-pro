/* The public scope, read from the ONE place that ships it.
   ...
   `src/lib/public-corpus.ts` holds the product decision (69 public journeys,
   ...
   Parsing rather than re-listing is the point: a second hand-kept copy of 69
...
/** The 69 journeys that are the public library. */
...
export const EXPECTED_PUBLIC_COUNT = 69;
