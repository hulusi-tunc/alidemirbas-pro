...
check(18, "AB/journey/blog counts used by sitemap.ts match the live data sources", abTests.length === 211 && journeyViewModel.length === 285 && blogPostCount === 5, `ab=${abTests.length}, journey=${journeyViewModel.length}, blog=${blogPostCount}`);
